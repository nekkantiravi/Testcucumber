Feature: As a MILITARY customer,
  ...
  @returns_regression @release_15H @domain_customer_management @project_return_management @priority_high @mode_domestic @artifact_shopapp @feature_military_returns @use_regression @returns_mgt_6 @use_domain_qual @run_this @migrated_to_sdt
