...
#####################################################################################################################
  ...
  @priority_high @domain_customer @dsv_sev2 @use_regression  @migrated_to_sdt
  ...
  @returns_regression @14H @artifact_shopapp @credit-6742 @priority_medium @use_regression @mode_domestic @returns_mgt_3 @s4a_stable @domain_customer @migrated_to_sdt
