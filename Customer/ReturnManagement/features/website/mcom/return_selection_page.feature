Feature: Verify Return Selection Page
  ...
  @use_regression @mode_domestic @priority_high @artifact_shopapp @returns_mgt_5 @shopapp_4 @s4a_stable @domain_customer @feature_returnselection @use_domain_qual  @migrated_to_sdt
  ...
  @returns_regression @use_regression @mode_domestic @priority_low  @artifact_shopapp @returns_mgt_2 @shopapp_4
  @s4a_stable @domain_customer @feature_returnselection @migrated_to_sdt
  ...
  @returns_regression @14K @use_regression @mode_domestic @priority_medium @credit-7171 @artifact_shopapp @domain_customer @migrated_to_sdt
  Scenario Outline: Thumbnail picture is displayed for Signed in users on the Return Selection page
    Given I visit the web site as a guest user
    When I navigate to selection page using "<order_type>" order as a "signed" user
    And I should see image displayed for each line item
    Examples:
      | order_type                                                     |
  ...
  Scenario:To verify that error message displayed when email_address and confirm_email_address does not match and clicks continue button as signed user
    Given I visit the web site as a guest user
    When I navigate to selection page using "intransit" order as a "signed" user
  ...
  Scenario:To verify that an error message displayed if "reason for return" dropdown value is empty or default value "Select a Reason for Return" exists for any return item as guest user
    Given I visit the web site as a guest user
    When I navigate to selection page using "intransit" order as a "guest" user
    And I attempt to continue without selecting reason for return in selection page
    Then I should see error message above the order details header
      | Please complete all fields to continue. |

  @returns_regression @14A @priority_low  @use_regression @mode_domestic @artifact_shopapp
  @returns_mgt_1 @shopapp_3 @s4a_stable @domain_customer @migrated_to_sdt
  ...
  Scenario:Verify that for signed in user is able to navigate SignIn page when clicks clicking on Continue button after session expires on the return selection page
    ...
    #Verify two links on the bottom of the return selection page where each link will take me to the appropriate help pages.
#Mingle Story:	http://mingle/projects/credit/cards/5718

  @returns_regression @14A @credit-5718 @use_regression @mode_domestic @priority_low  @artifact_shopapp
  @returns_mgt_1 @shopapp_3 @s4a_stable @domain_customer @migrated_to_sdt
  Scenario: Let us help link is correct on the return selection page
    Given I visit the web site as a guest user
    When I select "intransit" order as a "signed" user
    And I navigate to order history page
    When I select return items button in "OH" page
    ...
    And I navigate to "let us help" window page using let us help link in return selection page


  @returns_regression @14A @credit-5801 @use_regression @mode_domestic @priority_low  @artifact_shopapp @returns_mgt_1 @shopapp_3
  @s4a_stable @domain_customer @migrated_to_sdt
  Scenario: Private Policy link opens a new browser window
    Given I visit the web site as a guest user
    When I select "intransit" order as a "signed" user
    And I navigate to order history page
    And I select return items button in "OH" page
    Then I should see contact information section
    And I navigate to privacy policy window page using privacy policy link in return selection page
    And I should navigate to return selection page

      #An error message on the top of the page should be displayed and the error sections highlighted on the page if any validation fails when I click on the Continue button on the Return Selection page.
  #Mingle Story: http://mingle/projects/credit/cards/6499

  @14F @credit-6499 @artifact_shopapp @priority_medium @s4a_stable @use_regression @mode_domestic @domain_customer
  @returns_mgt_3 @migrated_to_sdt
  Scenario: Error messages should be displayed when a user does not enter any required fields on the Return Selection page
    Given I visit order history page as a guest user
    When I navigate to selection page using "shipping_and_billing_address_different_for_creditcard" order as a "guest" user
    And I attempt to continue in return selection page
    Then I should see error message above the order details header
      | Please complete all fields to continue. |

  @14F @credit-6499 @artifact_shopapp @priority_medium @s4a_stable @domain_customer @use_regression @mode_domestic
  @returns_mgt_1 @returns_regression @migrated_to_sdt
  Scenario: Error messages should be displayed when a user does not enter all required fields on the Return Selection page as signed user
    Given I visit order history page as a guest user
    When I navigate to selection page using "shipping_and_billing_address_different_for_creditcard" order as a "signed" user
    And I attempt to continue in return selection page
    Then I should see error message above the order details header
      | Please complete all fields to continue. |
    ...
    Then I should see error message above the order details header
      | Please complete all fields to continue. |
    And I select selected line item
    When I attempt to continue with emails in selection page
    Then I should see error message above the order details header
      | Please complete all fields to continue. |
    When I select any_refund option from refund section
    When I attempt to continue with emails in selection page
    Then I should see error message above the order details header
      | Please complete all fields to continue. |

  @returns_regression @14A @credit-5715 @use_regression @mode_domestic @priority_medium @artifact_shopapp
  @returns_mgt_1 @shopapp_3 @s4a_stable @domain_customer @migrated_to_sdt
  Scenario: Return instructions are correct on the Return Selection page
    Given I visit order history page as a guest user
    When I select "intransit" order as a "guest" user
    And I lookup with order number and emailaddress in OH page
    And I select return items button in "OD" page
    Then I should navigate to return selection page
    And I should see text "Select the items you'd like to return, the quantity & reason for your return below." in return instruction section

      #Verify Contact information section in return selection page.
  #Mingle Story: http://mingle/projects/credit/cards/5801

  @returns_regression @14A @credit-5801 @use_regression @mode_domestic @priority_medium @artifact_shopapp @returns_mgt_5 @shopapp_3
  @s4a_stable @domain_customer @migrated_to_sdt
  Scenario: Contact information is correct on the return selection page
    Given I visit order history page as a guest user
    When I select "intransit" order as a "guest" user
    And I lookup with order number and emailaddress in OH page
    And I select return items button in "OD" page
    Then I should see contact information section
    And I should verify information text in contact information section
      | if we have questions about your return, where can we reach you? Please review our Privacy Policy for details on how we protect your information. |

  @returns_regression @credit-6497 @artifact_shopapp @14F @priority_medium @s4a_stable @use_regression @mode_domestic
  @returns_mgt_5 @domain_customer @migrated_to_sdt
  Scenario: Refund help modal and refund methods verification
    Given I visit order history page as a guest user
    When I select "shipping_and_billing_address_different_for_creditcard" order as a "guest" user
    And I lookup with order number and emailaddress in OH page
    And I select return items button in "OD" page
    Then I should navigate to return selection page
    And I should see "In order to prevent fraud, we'll mail the Gift Card to your shipping address on file." in modal overlay when I click on refund help icon
    And I should not see modal overlay when I click on outside of overlay
    And I should see refund options in unselected state
    When I select orignal_payment option from refund section
    Then I should see the giftcard_payment refund option is cleared
    When I select giftcard_payment option from refund section
    Then I should see the orignal_payment refund option is cleared

  @returns_regression @credit-6497 @artifact_shopapp @14F @priority_medium @s4a_stable @returns_mgt_5 @domain_customer
  @use_regression @mode_domestic @migrated_to_sdt
  Scenario: Refund method is unique and text is correct on the Return Selection page
    Given I visit order history page as a guest user
    When I select "shipping_and_billing_address_different_for_creditcard" order as a "guest" user
    And I lookup with order number and emailaddress in OH page
    And I select return items button in "OD" page
    Then I should navigate to return selection page
    And I should see the text displayed "Select Refund Method" on gray bar on the Return selection Page
    And I should see refund options in unselected state
    When I select orignal_payment option from refund section
    Then I should see the giftcard_payment refund option is cleared
    When I select giftcard_payment option from refund section
  ...
  Scenario:To verify that on selecting NO in modal overlay user should be return selection page as guest user
    ...
    Then I should navigate to return selection page
      ...
      #To verify the Refund Method on the return selection page
  #Mingle Story: http://mingle/projects/customer_management/cards/6497

  @returns_regression @credit-6497 @artifact_shopapp @14F @priority_medium @s4a_stable @use_regression @mode_domestic @returns_mgt_5 @domain_customer @migrated_to_sdt
  Scenario: Refund method must be unique on the return selection page
    Given I visit order history page as a guest user
    When I select "shipping_and_billing_address_different_for_creditcard" order as a "guest" user
    And I lookup with order number and emailaddress in OH page
    And I select return items button in "OD" page
  ...
  @returns_regression @credit-6497 @artifact_shopapp @14F @priority_medium @returns_mgt_5 @domain_customer @use_regression @mode_domestic @migrated_to_sdt
  Scenario: Select refund method text is correct on the Return Selection page
    Given I visit order history page as a guest user
    When I select "shipping_and_billing_address_different_for_creditcard" order as a "guest" user
    And I lookup with order number and emailaddress in OH page
    And I select return items button in "OD" page
  ...
  @returns_regression @14F @credit-6499 @artifact_shopapp @priority_medium @s4a_stable @use_regression @mode_domestic @domain_customer @returns_mgt_1 @migrated_to_sdt
  Scenario: Error messages should be displayed when a Signed user does not enter an email address or reason to return on the Return Selection page
    Given I visit the web site as a guest user
    When I navigate to selection page using "shipping_and_billing_address_different_for_creditcard" order as a "signed" user
    When I select line item
    And I attempt to continue in return selection page
