...
Feature: Verify high level status on every return user have submitted
  ...
  @returns_regression @use_regression @mode_domestic @priority_medium @artifact_shopapp @returns_mgt_1 @shopapp_4 @domain_customer @saucelab_C @saucelab_C_F1 @run_this @migrated_to_sdt
  ...
  @14A @credit-5500 @use_regression @mode_domestic @priority_high @artifact_shopapp @returns_mgt_1 @shopapp_3 @domain_customer
