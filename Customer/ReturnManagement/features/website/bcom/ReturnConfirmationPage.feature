...
# @credit-5788 # @credit-5775 # @14A
  ...
  @14A @credit-5788 @use_regression @mode_domestic @priority_high @artifact_shopapp @returns_mgt_5 @shopapp_3 @domain_customer @migrated_to_sdt
  Scenario: Order Details are displayed in the Return Credit Section on the Return Confirmation page as a guest user
    Given I visit order history page as a guest user
    When I select "EGC" order as a "guest" user
    ...
    Then I should see "order number" same as in the order details page
    And I should see "order date" same as in the order details page