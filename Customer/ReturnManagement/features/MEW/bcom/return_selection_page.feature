...
Feature: Verify return selection page features on MEW
  ...
  @B-88816 @B-92033 @release_17X @domain_customer_management @project_return_management @use_project
  Scenario Outline: Verify user able navigate to refund method pages by selecting continue button
    ...
    When I tap order "<line_item_status>" on history page
    And I select return items button in mobile "OD" page
  ...
  @B-88811 @release_17X @domain_customer_management @project_return_management @use_project
  ...
  @B-88812 @release_17X @domain_customer_management @project_return_management @use_project
  ...
  @B-88813 @release_17X @domain_customer_management @project_return_management @use_project
  ...
  @B-88817 @release_17X @domain_customer_management @project_return_management @use_project
  ...
  Scenario: Verify weather global error message and field errors are disappeared when reason for return is selected.
    ...
    And I navigate to order history page on mobile
    When I tap order "delivered" on history page
    And I select return items button in mobile "OD" page
    Then I should navigate to "return selection" page
    And I select checkbox to return item
    When I select "continue" button on page
