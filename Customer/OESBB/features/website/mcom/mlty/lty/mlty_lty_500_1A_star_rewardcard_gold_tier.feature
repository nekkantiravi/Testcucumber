...
@mlcomm_lty_500_1A_star_rewardcard_gold_tier @regression 
Scenario: Verify Email content 
	Given i trigger "mlty_lty_500_1A_star_rewardcard_gold_tier" input through csp testemail 
