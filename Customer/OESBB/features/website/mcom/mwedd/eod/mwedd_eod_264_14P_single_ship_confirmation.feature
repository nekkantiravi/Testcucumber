Feature: Verify MWEDD 264 single ship confirmation email content
  ...
  @regression
  @mwedd_fil_264
  @mwedd_eod_264_14P_single_ship_confirmation
  Scenario: Verify Email content for template mwedd_eod_264_14P_single_ship_confirmation
	Given i trigger "mwedd_eod_264_14P_single_ship_confirmation" input through csp testemail
