Feature: Verify MWEDD 264 single ship confirmation email content
  ...
  @regression
  @mwedd_eod_264_14A_single_ship_confirmation
  @mwedd_fil_264
  Scenario: Verify Email content for template mwedd_eod_264_14A_single_ship_confirmation
    Given i trigger "mwedd_eod_264_14A_single_ship_confirmation" input through csp testemail
