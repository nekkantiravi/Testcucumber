Feature: Verify MWEDD 264 bops ready for pickup email content
  ...
  @mwedd_eod_264_14S_bops_ready_for_pickup @regression
  Scenario: Verify Email content for for template mwedd_eod_264_14S_bops_ready_for_pickup
    Given i trigger "mwedd_eod_264_14S_bops_ready_for_pickup" input through csp testemail
