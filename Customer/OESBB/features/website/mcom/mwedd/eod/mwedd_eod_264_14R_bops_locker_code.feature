Feature: Verify MWEDD 264 bops locker_code email content

  @mwedd_eod_264_14R_bops_locker_code @regression
  Scenario: Verify Email content for for template mwedd_eod_264_14R_bops_locker_code
    Given i trigger "mwedd_eod_264_14R_bops_locker_code" input through csp testemail
