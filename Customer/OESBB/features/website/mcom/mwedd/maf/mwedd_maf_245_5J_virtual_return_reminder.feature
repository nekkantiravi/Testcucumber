Feature: Verify MWEDD 245 virtual return reminder email content

  @regression
  Scenario: Verify email content for maf_245_5J_MWEDD template
    Given i trigger "mwedd_maf_245_5J_virtual_return_reminder" input through csp testemail
