Feature: Verify MWEDD 245 virtual return receipt email content

  @regression
  Scenario: Verify email content of maf_245_5L_MWEDD template
    Given i trigger "mwedd_maf_245_5L_virtual_return_receipt" input through csp testemail
