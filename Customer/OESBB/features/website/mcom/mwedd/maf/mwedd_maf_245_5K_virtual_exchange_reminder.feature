Feature: Verify MWEDD 245 virtual exchange reminder email content

  @regression
  Scenario: Verify email content for maf_245_5K_MWEDD template
    Given i trigger "mwedd_maf_245_5K_virtual_exchange_reminder" input through csp testemail
