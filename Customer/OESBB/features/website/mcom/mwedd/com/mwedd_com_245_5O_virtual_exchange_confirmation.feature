Feature: Verify COM 245 virtual return confirmation 245 5O MWEDD  email content

  @mwedd_com_245_5O_virtual_exchange_confirmation @regression
  Scenario: Verify Email content
    Given i trigger "mwedd_com_245_5O_virtual_exchange_confirmation" input through csp testemail
