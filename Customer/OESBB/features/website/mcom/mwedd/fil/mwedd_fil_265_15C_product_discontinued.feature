Feature: Verify MCOM 265 product discontinued email content
  ...
  @mwedd_fil_265_15C_product_discontinued @regression
  Scenario: Verify Email content for for template mwedd_fil_265_15C_product_discontinued
    Given i trigger "mwedd_fil_265_15C_product_discontinued" input through csp testemail
