Feature: Verify MWEDD 543 bops pickup reminder confirmation email content
  ...
  @regression
  Scenario: Verify Email content for for template mwedd_fil_543_1A_bops_pickup_reminder
    Given i trigger "mwedd_fil_543_1A_bops_pickup_reminder" input through csp testemail
