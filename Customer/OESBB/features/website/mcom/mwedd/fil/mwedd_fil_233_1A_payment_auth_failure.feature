Feature: Verify Mwedd payment authentication failure 233 1A MCOM  email content

  @mwedd_fil_233_1A_payment_auth_failure @regression @mwedd_fil_233 @Fedfil_233
  Scenario: Verify Email content for for template mwedd_fil_233_1A_payment_auth_failure
    Given i trigger "mwedd_fil_233_1A_payment_auth_failure" input through csp testemail
