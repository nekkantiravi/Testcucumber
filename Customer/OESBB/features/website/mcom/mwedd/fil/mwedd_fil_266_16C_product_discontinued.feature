Feature: Verify MCOM 265 product discontinued email content
  ...
  @mwedd_fil_266_16C_product_discontinued @regression
  Scenario: Verify Email content for for template mwedd_fil_266_16C_product_discontinued
    Given i trigger "mwedd_fil_266_16C_product_discontinued" input through csp testemail
