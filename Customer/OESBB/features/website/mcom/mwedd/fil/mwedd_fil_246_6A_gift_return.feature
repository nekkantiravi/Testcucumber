Feature: Verify MCOM 246 gift return email content
  ...
  @246_gift_return
  @regression
  Scenario: Verify Email content for for template mwedd_fil_246_6A_gift_return
    Given i trigger "mwedd_fil_246_6A_gift_return" input through csp testemail
    ...
    Then i should see body text:
      """
      We're processing your refund for the returned registry item(s). You'll receive a Macy's Gift Card by mail in the amount listed below. Please note: the Macy's Gift Card can be used to purchase merchandise online and in store; it isn't redeemable for cash. Thanks for shopping at Macy's! 
      """
