Feature: Verify MCOM 542 no bops items available timeout email content
  ...
  @mwedd_fil_542_30G_bops_order_offer_to_ship @regression
  Scenario: Verify Email content for for template mwedd_fil_542_30G_bops_order_order_offer_to_ship
    Given i trigger "mwedd_fil_542_30G_bops_order_offer_to_ship" input through csp testemail
