Feature: Verify MWEDD 324 challenge no call cancel email content

  @mwedd_fil_324_27_challenge_no_call_cancel @regression
  Scenario: Verify Email content for for template mwedd_fil_324_27_challenge_no_call_cancel
    Given i trigger "mwedd_fil_324_27_challenge_no_call_cancel" input through csp testemail
    And i have an enhanced payload sent to email provider
    When i navigate to view the email page
    Then i should see pre header:
      """
      There was an issue with your recent Macy's registry order. My Account
      """
