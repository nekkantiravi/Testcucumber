Feature: Verify MWEDD 264 bops ready for pickup email content
  ...
  @mwedd_fil_264_14Q_bops_ready_for_pickup @regression
  Scenario: Verify Email content for for template mwedd_fil_264_14Q_bops_ready_for_pickup
    Given i trigger "mwedd_fil_264_14Q_bops_ready_for_pickup" input through csp testemail
