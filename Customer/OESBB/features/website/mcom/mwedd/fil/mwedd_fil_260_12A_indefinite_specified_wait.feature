Feature: Verify email content for 260 indefinite specified wait template
  ...
  @mwedd_fil_260_12A_indefinite_specified_wait
  @regression
  
  Scenario: Verify Email content  for template mwedd_fil_260_12A_indefinite_specified_wait
    Given i trigger "mwedd_fil_260_12A_indefinite_specified_wait" input through csp testemail
