Feature: Verify FIL 360 virtual exchange confirmation 360 1B MWEDD email content

  @mwedd_fil_360_1B_virtual_exchange_confirmation @regression
  Scenario: Verify Email content
    Given i trigger "mwedd_fil_360_1B_virtual_exchange_confirmation" input through csp testemail
