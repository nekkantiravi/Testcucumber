Feature: Verify MWEDD 540 split shipment notification email content
  ...
  @regression
  @mwedd_fil_540_1L_split_shipment_notification
  @mwedd_fil_540
  Scenario: Verify Email content for tempalte mwedd_fil_540_1L_split_shipment_notification
	Given i trigger "mwedd_fil_540_1L_split_shipment_notification" input through csp testemail
