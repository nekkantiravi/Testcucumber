Feature: Verify MWEDD 360 re-ship confirmation email content
  ...
  @mwedd_fil_360_1C_re-ship_confirmation 
  @regression
  Scenario: Verify Email content for for template mwedd_fil_360_1C_re-ship_confirmation
    Given i trigger "mwedd_fil_360_1C_re-ship_confirmation" input through csp testemail
