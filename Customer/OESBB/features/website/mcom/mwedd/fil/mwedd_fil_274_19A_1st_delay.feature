Feature: Verify email content for 275_1st_delay template
  ...
  @mwedd_fil_274_19A_1st_delay @regression
  Scenario: Verify Email content for template mwedd_fil_274_19A_1st_delay
    Given i trigger "mwedd_fil_274_19A_1st_delay" input through csp testemail
    ...
    #And i should see body text having system cancel date:
      #"""
      #We're sorry, the item(s) listed below are on backorder with the vendor. The new estimated ship date is 03/22/2018.Note: We need to hear from you by 01/12/2018 to confirm you're willing to wait for the item(s). Simply reply to this email or call us at 1-800-BUY-MACY (1-800-289-6229). Otherwise, we'll have to cancel your backorder on 01/12/2018.You may cancel your backorder at any time before it's shipped and you won't be charged. We appreciate your patience.
      #"""
