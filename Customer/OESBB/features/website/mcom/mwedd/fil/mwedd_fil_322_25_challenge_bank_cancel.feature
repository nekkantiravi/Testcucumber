Feature: Verify MCOM 322 challenge bank cancel email content
   ...
   @mwedd_fil_322_25_challenge_bank_cancel @regression
   Scenario: Verify Email content for for template mwedd_fil_322_25_challenge_bank_cancel
     Given i trigger "mwedd_fil_322_25_challenge_bank_cancel" input through csp testemail
     And i have an enhanced payload sent to email provider
     When i navigate to view the email page
     Then i should see pre header:
       """
       There was an issue with your registry order. My Account
       """
