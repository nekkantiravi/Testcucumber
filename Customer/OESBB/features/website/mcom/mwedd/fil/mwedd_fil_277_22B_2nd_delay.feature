Feature: Verify MCOM 278 2nd delay email content
  ...
  @mwedd_fil_277_22B_2nd_delay @regression
  Scenario: Verify Email content for for template mwedd_fil_277_22B_2nd_delay
    Given i trigger "mwedd_fil_277_22B_2nd_delay" input through csp testemail
