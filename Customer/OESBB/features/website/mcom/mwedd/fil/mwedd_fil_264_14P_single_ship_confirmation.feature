Feature: Verify MWEDD 264 single ship confirmation email content

  @regression
  @mwedd_fil_264
  @mwedd_fil_264_14P_single_shipment_confirmation
  Scenario: Verify Email content for template mwedd_fil_264_14P_single_shipment_confirmation
	Given i trigger "mwedd_fil_264_14P_single_shipment_confirmation" input through csp testemail
