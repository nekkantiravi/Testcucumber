Feature: Verify email content for 275_1st_delay template
  ...
  @mwedd_fil_276_21D_1st_delay @regression
  Scenario: Verify Email content for template mwedd_fil_276_21D_1st_delay
    Given i trigger "mwedd_fil_276_21D_1st_delay" input through csp testemail
