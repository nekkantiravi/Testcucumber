Feature: Verify MWEDD 264 single ship confirmation email content
	...
	@regression
	@mwedd_fil_264_14H_single_shipment_confirmation
	@mwedd_fil_264
	Scenario: Verify Email content for template mwedd_fil_264_14H_single_ship_confirmation
		Given i trigger "mwedd_fil_264_14H_single_shipment_confirmation" input through csp testemail
