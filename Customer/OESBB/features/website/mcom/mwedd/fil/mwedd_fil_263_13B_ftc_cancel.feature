Feature: Verify MWEDD 263_ftc_cancel email content

  @mwedd_fil_263_13B_ftc_cancel @regression
  Scenario: Verify email content for tempalte mwedd_fil_263_13B_ftc_cancel
    Given i trigger "mwedd_fil_263_13B_ftc_cancel" input through csp testemail
    And i have an enhanced payload sent to email provider
    When i navigate to view the email page
    Then i should see pre header:
      """
      We had to cancel your registry order. Shop Macy's
      """
