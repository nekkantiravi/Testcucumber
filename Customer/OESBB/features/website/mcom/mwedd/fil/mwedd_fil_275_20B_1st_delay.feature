Feature: Verify email content for 275_1st_delay template
  ...
  @mwedd_fil_275_20B_1st_delay @regression
  Scenario: Verify Email content for template mwedd_fil_275_20B_1st_delay
    Given i trigger "mwedd_fil_275_20B_1st_delay" input through csp testemail
    ...
    #And i should see body text having system cancel date:
      #"""
      #We're sorry, the item(s) listed below are on backorder with the vendor. The new estimated ship date is 01/02/2017. You may cancel your backorder at any time before it ships and you won't be charged. Simply reply to this email or call us at 1-800-BUY-MACY (1-800-289-6229). We appreciate your patience.
      #"""
