Feature: Verify MWEDD 245 virtual return confirmation 245 5F MWEDD  email content

  @mwedd_fil_245_5F_virtual_return_confirmation @regression
  Scenario: Verify Email content
    Given i trigger "mwedd_fil_245_5F_virtual_return_confirmation" input through csp testemail
