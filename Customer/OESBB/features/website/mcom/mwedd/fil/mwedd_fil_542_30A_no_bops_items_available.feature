Feature: Verify MCOM 542 no bops items available email content
  ...
  @mwedd_fil_542_30A_no_bops_items_available @regression
  Scenario: Verify Email content for for template mwedd_fil_542_30A_no_bops_items_available
    Given i trigger "mwedd_fil_542_30A_no_bops_items_available" input through csp testemail
