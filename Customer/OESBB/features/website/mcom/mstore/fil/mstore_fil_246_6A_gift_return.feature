Feature: Verify MCOM 246 gift return email content
  ...
  @246_gift_return
 @mstore_fil_246_6A_gift_return  @regression
  Scenario: Verify Email content for for template mstore_fil_246_6A_gift_return
    Given i trigger "mstore_fil_246_6A_gift_return" input through csp testemail
