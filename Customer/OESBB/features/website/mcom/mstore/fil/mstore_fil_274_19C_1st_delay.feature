Feature: Verify email content for 275_1st_delay template
  ...
  @mstore_fil_274_19C_1st_delay @regression
  Scenario: Verify Email content for template mstore_fil_274_19C_1st_delay
    Given i trigger "mstore_fil_274_19C_1st_delay" input through csp testemail
