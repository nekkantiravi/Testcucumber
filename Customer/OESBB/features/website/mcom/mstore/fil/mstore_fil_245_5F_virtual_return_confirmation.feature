Feature: Verify MSTORE 245 virtual return confirmation 245 5F MSTORE  email content

  @mstore_fil_245_5F_virtual_return_confirmation @regression
  Scenario: Verify Email content
    Given i trigger "mstore_fil_245_5F_virtual_return_confirmation" input through csp testemail
