Feature: Verify MSTORE 540 split shipment notification email content
  ...
  @regression
  @mstore_fil_540_1M_split_shipment_notification
  @mstore_fil_540
  Scenario: Verify Email content for template mstore_fil_540_1M_split_shipment_notification
		Given i trigger "mstore_fil_540_1M_split_shipment_notification" input through csp testemail
