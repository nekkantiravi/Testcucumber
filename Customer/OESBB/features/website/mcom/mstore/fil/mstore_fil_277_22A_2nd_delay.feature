Feature: Verify MCOM 278 2nd delay email content
  ...
  @mstore_fil_277_22A_2nd_delay @regression
  Scenario: Verify Email content for for template mstore_fil_277_22A_2nd_delay
    Given i trigger "mstore_fil_277_22A_2nd_delay" input through csp testemail
    ...
    #  """
    #Were sorry, but item(s) from order #<ordernumber> are further delayed with the vendor. At this time, the vendor is unable to provide a new ship date.
