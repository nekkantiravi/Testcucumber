Feature: Verify MSTORE 264 single shipment confirmation email content
	...
	@regression
    @mstore_fil_264_14A_single_shipment_confirmation
    @mstore_fil_264
  	Scenario: Verify Email content for tempalte mstore_fil_264_14A_single_shipment_confirmation
		Given i trigger "mstore_fil_264_14A_single_shipment_confirmation" input through csp testemail
	...
	@production
  	Scenario: Production : Verify email template for mstore_fil_264_14A_single_shipment_confirmation
    Given i trigger "mstore_fil_264_14A_single_shipment_confirmation" input through csp testemail    
    When i navigate to view the email page
