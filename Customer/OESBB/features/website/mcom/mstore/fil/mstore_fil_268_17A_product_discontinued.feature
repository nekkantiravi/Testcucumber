Feature: Verify MCOM 265 product discontinued email content
  ...
  @mstore_fil_268_17A_product_discontinued @regression
  Scenario: Verify Email content for for template mstore_fil_268_17A_product_discontinued
    Given i trigger "mstore_fil_268_17A_product_discontinued" input through csp testemail
