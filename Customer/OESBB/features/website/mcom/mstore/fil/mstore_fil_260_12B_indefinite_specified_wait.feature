Feature: Verify MCOM 260 indefinite specified wait  email content
  ...
  @mstore_fil_260_12B_indefinite_specified_wait  @regression
  Scenario: Verify Email content for for template mstore_fil_260_12B_indefinite_specified_wait
    Given i trigger "mstore_fil_260_12B_indefinite_specified_wait" input through csp testemail
