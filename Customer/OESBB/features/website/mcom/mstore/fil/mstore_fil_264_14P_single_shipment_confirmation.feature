Feature: Verify MSTORE 264 single shipment confirmation email content
  	...
  	@regression
  	@mstore_fil_264_14P_single_shipment_confirmation
  	@mstore_fil_264
  	Scenario: Verify Email content for template mstore_fil_264_14P_single_shipment_confirmation
		Given i trigger "mstore_fil_264_14P_single_shipment_confirmation" input through csp testemail
