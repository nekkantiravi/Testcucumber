Feature: Verify MSTORE 522 ship credit decline cancel email content

  @mstore_fil_522_1A_ship_credit_decline_cancel @regression
  Scenario: Verify Email content for for template mstore_fil_522_1A_ship_credit_decline_cancel
    Given i trigger "mstore_fil_522_1A_ship_credit_decline_cancel" input through csp testemail
