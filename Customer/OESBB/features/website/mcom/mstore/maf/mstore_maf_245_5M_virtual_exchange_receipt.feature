Feature: Verify MSTORE 245 virtual exchange receipt email content

  @regression
  Scenario: Verify email content for maf_245_5M_MCOM template
    Given i trigger "mstore_maf_245_5M_virtual_exchange_receipt" input through csp testemail
