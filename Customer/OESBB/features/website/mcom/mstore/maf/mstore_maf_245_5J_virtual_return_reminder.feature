Feature: Verify MSTORE 245 virtual return reminder email content

  @regression
  Scenario: Verify email content for maf_245_5J_MSTORE template
    Given i trigger "mstore_maf_245_5J_virtual_return_reminder" input through csp testemail
