Feature: Verify MSTORE 264 single shipment confirmation email content
	...
	@regression
    @mstore_eod_264_14A_single_shipment_confirmation
    @mstore_fil_264
  	Scenario: Verify Email content for tempalte mstore_eod_264_14A_single_shipment_confirmation
		Given i trigger "mstore_eod_264_14A_single_shipment_confirmation" input through csp testemail
