Feature: Verify MSTORE 524 Pended order notification email content

@regression @mstore_eod_524_1A_pended_order
  Scenario: Verify Email content for template mstore_eod_524_1A_pended_order notification
    Given i trigger "mstore_eod_524_1A_pended_order" input through csp testemail
    ...
    Then i should see pre header:
      """
     	We can't process Macy's order# 441569336 . My Account
      """
