Feature: Verify MSTORE 264 Multi shipment confirmation email content
	...
	@regression
    @mstore_eod_264_14B_multi_ship_confirmation
    @mstore_eod_264
	Scenario: Verify Email content for tempalte mstore_eod_264_14B_multi_ship_confirmation
		Given i trigger "mstore_eod_264_14B_multi_ship_confirmation" input through csp testemail
