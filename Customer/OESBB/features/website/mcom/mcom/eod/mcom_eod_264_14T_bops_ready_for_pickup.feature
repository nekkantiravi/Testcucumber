Feature: Verify MCOM 264 bops ready for pickup email content
  ...
  @mcom_eod_264_14T_bops_ready_for_pickup @regression
  Scenario: Verify Email content for for template mcom_eod_264_14T_bops_ready_for_pickup
    Given i trigger "mcom_eod_264_14T_bops_ready_for_pickup" input through csp testemail
    And i have an enhanced payload sent to email provider
    When i navigate to view the email page
    Then i should see pre header:
      """
      The rest of the order is ready for pick up.
      """
