Feature: Verify MCOM 524 Pended order notification email content

@regression @mcom_eod_524_1A_pended_order
  Scenario: Verify Email content for template mcom_eod_524_1A_pended_order notification
    Given i trigger "mcom_eod_524_1A_pended_order" input through csp testemail
