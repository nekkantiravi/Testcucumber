Feature: Verify MCOM 264 bops ready for pickup email content
  ...
  @mcom_eod_264_14R_bops_ready_for_pickup @regression
  Scenario: Verify Email content for for template mcom_eod_264_14R_bops_ready_for_pickup
    Given i trigger "mcom_eod_264_14R_bops_ready_for_pickup" input through csp testemail
