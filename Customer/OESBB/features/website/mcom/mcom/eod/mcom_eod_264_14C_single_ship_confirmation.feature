Feature: Verify MCOM 264 single shipment confirmation email content
  ...
  @regression
  @mcom_eod_264_14C_single_shipment_confirmation
  @mcom_eod_264
  Scenario: Verify Email content for tempalte mcom_eod_264_14C_single_shipment_confirmation
	Given i trigger "mcom_eod_264_14C_single_shipment_confirmation" input through csp testemail
