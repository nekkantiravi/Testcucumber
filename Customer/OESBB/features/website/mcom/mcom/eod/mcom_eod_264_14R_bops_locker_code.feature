Feature: Verify MCOM 264 bops locker code email content

  @mcom_eod_264_14R_bops_locker_code @regression
  Scenario: Verify Email content for for template mcom_eod_264_14R_bops_locker_code
    Given i trigger "mcom_eod_264_14R_bops_locker_code" input through csp testemail
    ...
    And i should see sales tax in the emaill
