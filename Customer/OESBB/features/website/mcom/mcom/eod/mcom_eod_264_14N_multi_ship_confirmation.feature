Feature: Verify MCOM 264 multi shipment confirmation email content
  ...
  @regression @mcom_eod_264_14N_multi_ship_confirmation @mcom_eod_264
  Scenario: Verify Email content for tempalte mcom_eod_264_14N_multi_ship_confirmation
    Given i trigger "mcom_eod_264_14N_multi_ship_confirmation" input through csp testemail
