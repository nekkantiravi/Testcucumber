Feature: Verify MCOM 264 bops Locker Code
  
  @mcom_eod_264_14Q_bops_locker_code @regression
  Scenario: Verify Email content for for template mcom_eod_264_14Q_bops_locker_code
    Given i trigger "mcom_eod_264_14Q_bops_locker_code" input through csp testemail
