Feature: Verify MCOM 240 bops order confirmation email content
  ...
  @mcom_fil_240_1N_bops_order_confirmation 
  @regression
  Scenario: Verify Email content for for template mcom_fil_240_1N_bops_order_confirmation
    Given i trigger "mcom_fil_240_1N_bops_order_confirmation" input through csp testemail
    ...
    And i should see body text:
      """
      Thanks for shopping at macys.com. Once your order is processed, we'll send additional details. Don't worry, you won't be charged until then.
      """
    ...
    @optional
   Scenario: Verify optional fields empty scenario for template mcom_fil_240_1N_bops_order_confirmation
    Given i trigger "mcom_fil_240_1N_bops_order_confirmation_optional" input through csp testemail
    When i navigate to view the email page
