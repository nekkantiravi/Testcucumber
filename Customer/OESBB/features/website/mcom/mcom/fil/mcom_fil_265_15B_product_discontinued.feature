Feature: Verify MCOM 265 product discontinued email content
  ...
  @mcom_fil_265_15B_product_discontinued @regression
  Scenario: Verify Email content for for template mcom_fil_265_15B_product_discontinued
    Given i trigger "mcom_fil_265_15B_product_discontinued" input through csp testemail
  ...
  @optional
  Scenario: Verify optional fields empty scenario for template mcom_fil_265_15B_product_discontinued
    Given i trigger "mcom_fil_265_15B_product_discontinued_optional" input through csp testemail
    When i navigate to view the email page
