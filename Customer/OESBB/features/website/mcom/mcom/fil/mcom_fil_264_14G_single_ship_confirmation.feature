Feature: Verify MCOM 264 single shipment confirmation email content
  ...
  @mcom_fil_264_14G_single_ship_confirmation
  @regression
  @mcom_fil_264
  Scenario: Verify Email content for template mcom_fil_264_14G_single_shipment_confirmation
    Given i trigger "mcom_fil_264_14G_single_shipment_confirmation" input through csp testemail
