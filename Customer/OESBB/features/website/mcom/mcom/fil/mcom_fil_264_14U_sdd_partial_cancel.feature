Feature: Verify MCOM 264 sdd partial cancel email content
  ...
  @mcom_fil_264_14U_sdd_partial_cancel
  @regression
  Scenario: Verify Email content for template mcom_fil_264_14U_sdd_partial_cancel
    Given i trigger "mcom_fil_264_14U_sdd_partial_cancel" input through csp testemail
   ...
   @optional
   Scenario: Verify optional fields empty scenario for template mcom_fil_264_14U_sdd_partial_cancel
    Given i trigger "mcom_fil_264_14U_sdd_partial_cancel_optional" input through csp testemail
    When i navigate to view the email page
