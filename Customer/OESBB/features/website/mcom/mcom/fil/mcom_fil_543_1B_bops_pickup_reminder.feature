Feature: Verify MCOM 543 bops pickup reminder confirmation email content
  ...
  @regression
  Scenario: Verify Email content for for template mcom_fil_543_1B_bops_pickup_reminder
    Given i trigger "mcom_fil_543_1B_bops_pickup_reminder" input through csp testemail
