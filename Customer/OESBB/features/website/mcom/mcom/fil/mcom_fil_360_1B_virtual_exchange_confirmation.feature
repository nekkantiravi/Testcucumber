Feature: Verify FIL 360 virtual exchange confirmation 360 1B MCOM email content

  @mcom_fil_360_1B_virtual_exchange_confirmation @regression
  Scenario: Verify Email content
    Given i trigger "mcom_fil_360_1B_virtual_exchange_confirmation" input through csp testemail
  ...
  @optional
  Scenario: Verify optional fields empty scenario for template mcom_fil_360_1B_virtual_exchange_confirmation
    Given i trigger "mcom_fil_360_1B_virtual_exchange_confirmation_optional" input through csp testemail
    When i navigate to view the email page
