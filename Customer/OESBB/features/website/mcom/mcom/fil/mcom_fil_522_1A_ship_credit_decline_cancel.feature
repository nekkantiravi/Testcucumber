Feature: Verify MCOM 522 ship credit decline cancel email content

  @mcom_fil_522_1A_ship_credit_decline_cancel @regression
  Scenario: Verify Email content for for template mcom_fil_522_1A_ship_credit_decline_cancel
    Given i trigger "mcom_fil_522_1A_ship_credit_decline_cancel" input through csp testemail
  ...
  @optional
  Scenario: Verify optional fields empty scenario for template mcom_fil_522_1A_ship_credit_decline_cancel
    Given i trigger "mcom_fil_522_1A_ship_credit_decline_cancel_optional" input through csp testemail
    When i navigate to view the email page
