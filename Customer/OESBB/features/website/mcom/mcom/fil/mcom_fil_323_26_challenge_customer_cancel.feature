Feature: Verify MCOM 323 challenge customer cancel email content

  @mcom_fil_323_26_challenge_customer_cancel @regression
  Scenario: Verify Email content for for template mcom_fil_323_26_challenge_customer_cancel
    Given i trigger "mcom_fil_323_26_challenge_customer_cancel" input through csp testemail
   ...
   @optional
   Scenario: Verify optional fields empty scenario for template mcom_fil_323_26_challenge_customer_cancel
    Given i trigger "mcom_fil_323_26_challenge_customer_cancel_optional" input through csp testemail
    When i navigate to view the email page
