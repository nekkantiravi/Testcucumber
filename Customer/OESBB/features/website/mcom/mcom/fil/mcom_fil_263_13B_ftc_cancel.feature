Feature: Verify MCOM 263_ftc_cancel email content

  @mcom_fil_263_13B_ftc_cancel @regression
  Scenario: Verify email content for tempalte mcom_fil_263_13B_ftc_cancel
    Given i trigger "mcom_fil_263_13B_ftc_cancel" input through csp testemail
  ...
  @optional
  Scenario: Verify optional fields empty scenario for template mcom_fil_263_13B_ftc_cancel
    Given i trigger "mcom_fil_263_13B_ftc_cancel_optional" input through csp testemail
    When i navigate to view the email page
