Feature: Verify MCOM 542 bops order late pickup cancel email content
  ...
  @mcom_fil_542_30D_bops_order_late_pickup_cancel @regression
  Scenario: Verify Email content for for template mcom_fil_542_30D_bops_order_late_pickup_cancel
    Given i trigger "mcom_fil_542_30D_bops_order_late_pickup_cancel" input through csp testemail
    ...
    And i should see body text for 542 30D bops order late pickup cancel:
      """
      We're sorry, the final pick-up date has passed and <billingfirstname>'s order is no longer available at <storename>. We're letting you know because you were listed as the pick-up contact.
      """
