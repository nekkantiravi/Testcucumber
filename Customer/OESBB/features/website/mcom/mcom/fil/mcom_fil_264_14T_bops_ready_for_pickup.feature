Feature: Verify MCOM 264 bops ready for pickup email content
  ...
  @mcom_fil_264_14T_bops_ready_for_pickup @regression
  Scenario: Verify Email content for for template mcom_fil_264_14T_bops_ready_for_pickup
    Given i trigger "mcom_fil_264_14T_bops_ready_for_pickup" input through csp testemail
