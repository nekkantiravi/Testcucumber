Feature: Verify MCOM 540 split shipment notification email content
  ...
  @mcom_fil_540_1I_split_shipment_notification 
  @regression
  @mcom_fil_540
  Scenario: Verify Email content for template mcom_fil_540_1I_split_shipment_notification
    Given i trigger "mcom_fil_540_1I_split_shipment_notification" input through csp testemail
