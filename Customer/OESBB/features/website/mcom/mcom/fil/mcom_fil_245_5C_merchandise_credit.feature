Feature: Verify email content for 245_merchandise_credit template
  @mcom_fil_245_5C_merchandise_credit
  @regression
  Scenario: Verify Email content
    Given i trigger "mcom_fil_245_5C_merchandise_credit" input through csp testemail
  ...
  @optional
  Scenario: Verify optional fields empty scenario for template mcom_fil_245_5C_merchandise_credit
    Given i trigger "mcom_fil_245_5C_merchandise_credit_optional" input through csp testemail
    When i navigate to view the email page
