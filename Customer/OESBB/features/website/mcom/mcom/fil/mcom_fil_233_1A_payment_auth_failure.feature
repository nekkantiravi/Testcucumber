Feature: Verify MCOM payment authentication failure 233 1A MCOM  email content

  @mcom_fil_233_1A_payment_auth_failure @regression @mcom_fil_233 @Fedfil_233
  Scenario: Verify Email content for for template mcom_fil_233_1A_payment_auth_failure
    Given i trigger "mcom_fil_233_1A_payment_auth_failure" input through csp testemail
