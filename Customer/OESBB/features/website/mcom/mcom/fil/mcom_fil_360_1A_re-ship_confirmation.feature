Feature: Verify MCOM 360 re-ship confirmation email content
  ...
  @mcom_fil_360_1A_re-ship_confirmation 
  @regression
  Scenario: Verify Email content for for template mcom_fil_360_1A_re-ship_confirmation
    Given i trigger "mcom_fil_360_1A_re-ship_confirmation" input through csp testemail
