Feature: Verify MCOM 260 indefinite specified wait  email content
  ...
  @mcom_fil_260_12B_indefinite_specified_wait @regression @mcom_fil_260
  Scenario: Verify Email content for for template mcom_fil_260_12B_indefinite_specified_wait
    Given i trigger "mcom_fil_260_12B_indefinite_specified_wait" input through csp testemail
