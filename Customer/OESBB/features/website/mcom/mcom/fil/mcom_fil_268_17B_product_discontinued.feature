Feature: Verify MCOM 265 product discontinued email content
  ...
  @mcom_fil_268_17B_product_discontinued @regression
  Scenario: Verify Email content for for template mcom_fil_268_17B_product_discontinued
    Given i trigger "mcom_fil_268_17B_product_discontinued" input through csp testemail
