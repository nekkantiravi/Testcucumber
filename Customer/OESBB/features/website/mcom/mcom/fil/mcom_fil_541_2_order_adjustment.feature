Feature: Verify MCOM 541 order adjustment email content

  @mcom_fil_541_2_order_adjustment 
  @regression
  Scenario: Verify Email content for for template mcom_fil_541_2_order_adjustment
    Given i trigger "mcom_fil_541_2_order_adjustment" input through csp testemail
