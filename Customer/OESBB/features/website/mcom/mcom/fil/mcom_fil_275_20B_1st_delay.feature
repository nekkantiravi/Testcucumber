Feature: Verify email content for 275_1st_delay template
  ...
  @mcom_fil_275_20B_1st_delay @regression @mcom_fil_275
  Scenario: Verify Email content for template mcom_fil_275_20B_275_1st_delay
    Given i trigger "mcom_fil_275_20B_1st_delay" input through csp testemail
    ...
    #"""
    #We’re sorry, the item(s) listed below are on backorder with the vendor. The new estimated ship date is 01/01/2017. You may cancel your backorder at any time before it ships and you won’t be charged. Simply reply to this email or call us at 1-800-BUY-MACY (1-800-289-6229). We appreciate your patience.
    #"""
  ...
  @optional
  Scenario: Verify optional fields empty scenario for template mcom_fil_275_20B_1st_delay
    Given i trigger "mcom_fil_275_20B_1st_delay_optional" input through csp testemail
    When i navigate to view the email page
