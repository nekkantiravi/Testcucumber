 Feature: Verify MCOM 540 split shipment notification email content
  
  @regression
  @mcom_fil_540_1C_split_shipment_notification
  @mcom_fil_540
  Scenario: Verify Email content for template mcom_fil_540_1C_split_shipment_notification
	Given i trigger "mcom_fil_540_1C_split_shipment_notification" input through csp testemail
	...
	And i should see estimated ship dates
	 ...
	 @optional
   Scenario: Verify optional fields empty scenario for template mcom_fil_540_1C_split_shipment_notification
    Given i trigger "mcom_fil_540_1C_split_shipment_notification_optional" input through csp testemail
    When i navigate to view the email page
