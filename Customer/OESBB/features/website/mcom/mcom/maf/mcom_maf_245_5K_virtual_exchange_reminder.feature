Feature: Verify MCOM 245 virtual exchange reminder email content

  @regression
  Scenario: Verify email content for maf_245_5K_MCOM template
    Given i trigger "mcom_maf_245_5K_virtual_exchange_reminder" input through csp testemail
  ...
  @optional
  Scenario: Verify optional fields empty scenario for template mcom_maf_245_5K_virtual_exchange_reminder
    Given i trigger "mcom_maf_245_5K_virtual_exchange_reminder_optional" input through csp testemail
