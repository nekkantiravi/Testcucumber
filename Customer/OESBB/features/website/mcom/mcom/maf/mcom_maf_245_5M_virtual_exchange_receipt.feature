Feature: Verify MCOM 245 virtual exchange receipt email content

  @regression
  Scenario: Verify email content for maf_245_5M_MCOM template
    Given i trigger "mcom_maf_245_5M_virtual_exchange_receipt" input through csp testemail
  ...
  @optional
  Scenario: Verify optional fields empty scenario for template mcom_maf_245_5M_virtual_exchange_receipt
    Given i trigger "mcom_maf_245_5M_virtual_exchange_receipt_optional" input through csp testemail
