Feature: Verify MCOM 603 paperless COM 603 1F MCOM  email content

  @mcom_com_603_1F_paperless @regression
  Scenario: Verify Email content for for template mcom_com_603_1F_paperless
    Given i trigger "mcom_com_603_1F_paperless" input through csp testemail
