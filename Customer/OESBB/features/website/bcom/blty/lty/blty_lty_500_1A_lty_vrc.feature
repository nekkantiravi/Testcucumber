Feature: Verify BLTY LTY vrc email content
  ...
  @blty_lty_500_1A_lty_vrc @regression
  Scenario: Verify Email content for template blty_lty_500_1A_lty_vrc
    Given i trigger "blty_lty_500_1A_lty_vrc" input through csp testemail
