Feature: Verify fedfil bops order notification bwedd_264_14T email content
  ...
  @regression
  @bwedd_eod_264_14T_fedfil_bops_order_notification
  @bwedd_eod_264
  Scenario: Verify email content for template bwedd_eod_264_14T_fedfil_bops_order_notification
    Given i trigger "bwedd_eod_264_14T_fedfil_bops_order_notification" input through csp testemail
