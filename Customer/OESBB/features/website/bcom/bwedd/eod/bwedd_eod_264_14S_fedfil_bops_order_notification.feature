Feature: Verify fedfil_bops_order_notification 264_14S_BWEDD email content
  ...
  @regression
  @bwedd_eod_264_14S_fedfil_bops_order_notification
  @bwedd_eod_264
  Scenario: Verify email content for template bwedd_eod_264_14S_fedfil_bops_order_notification
    Given i trigger "bwedd_eod_264_14S_fedfil_bops_order_notification" input through csp testemail
