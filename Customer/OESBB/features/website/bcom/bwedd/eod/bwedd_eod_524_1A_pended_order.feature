Feature: Verify BWEDD 524 Pended order notification email content

@regression @bwedd_eod_524_1A_pended_order
  Scenario: Verify Email content for template bwedd_eod_524_1A_pended_order notification
    Given i trigger "bwedd_eod_524_1A_pended_order" input through csp testemail
