Feature: Verify fedfil  shipment email content
  ...
  @bwedd_eod_264_14H_fedfil_shipment_confirmation @regression @bwedd_eod_264
  Scenario: Verify email content for template bwedd_eod_264_14H_fedfil_shipment_confirmation
