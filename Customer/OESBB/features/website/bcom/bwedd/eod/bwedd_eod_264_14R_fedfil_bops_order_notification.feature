Feature: Verify fedfil bops order notification 264_14R_BWEDD email content
  ...
  @bwedd_eod_264_14R_fedfil_bops_order_notification
  @regression
  @bwedd_eod_264
  Scenario: Verify email content for template bwedd_eod_264_14R_fedfil_bops_order_notification
    Given i trigger "bwedd_eod_264_14R_fedfil_bops_order_notification" input through csp testemail
