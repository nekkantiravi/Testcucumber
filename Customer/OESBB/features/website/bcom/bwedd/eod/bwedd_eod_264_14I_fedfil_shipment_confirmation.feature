Feature: Verify fedfil  shipment email content
  ...
  @bwedd_eod_264_14I_fedfil_shipment_confirmation @regression @bwedd_eod_264
  Scenario: Verify email content for template bwedd_eod_264_14I_fedfil_shipment_confirmation
    Given i trigger "bwedd_eod_264_14I_fedfil_shipment_confirmation" input through csp testemail
