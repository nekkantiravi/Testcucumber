Feature: Verify fedfil order confirmation templates
  ...
  @bwedd_fil_360_1A_fedfil_order_confirmation_shoprunner_shipping 
  @regression
  @bwedd_fil_360
  Scenario: Verify email content for template bwedd_fil_360_1A_fedfil_order_confirmation_shoprunner_shipping
    Given i trigger "bwedd_fil_360_1A_fedfil_order_confirmation_shoprunner_shipping" input through csp testemail
