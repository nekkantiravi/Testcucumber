Feature: Verify BWEDD 542 fedfil bops late pickup cancel email content

  @regression
  @bwedd_fil_542_30D_fedfil_bops_late_pickup_cancel 
  
  Scenario: Verify Email content for template bwedd_fil_542_30D_fedfil_bops_late_pickup_cancel
    Given i trigger "bwedd_fil_542_30D_fedfil_bops_late_pickup_cancel" input through csp testemail
