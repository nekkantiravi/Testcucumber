Feature: Verify fedfil mixbag order email content
  ...
  @bwedd_fil_240_1P_fedfil_mixbag_order_shoprunner_shipping @regression
  Scenario: Verify email content for bwedd 240 1P mixbag order template for shoprunner
    Given i trigger "bwedd_fil_240_1P_fedfil_mixbag_order_shoprunner_shipping" input through csp testemail
