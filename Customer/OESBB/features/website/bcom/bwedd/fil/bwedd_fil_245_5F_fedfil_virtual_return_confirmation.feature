Feature: Verify BWEDD 245 virtual return confirmation email content

  @regression @bwedd_fil_245_5F_fedfil_virtual_return_confirmation
  Scenario: Verify Email content for template bwedd_fil_245_5F_fedfil_virtual_return_confirmation
    Given i trigger "bwedd_fil_245_5F_fedfil_virtual_return_confirmation" input through csp testemail
