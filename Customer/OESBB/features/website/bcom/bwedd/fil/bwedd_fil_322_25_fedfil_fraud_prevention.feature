 Feature: Verify BWEDD 322 fedfil fraud prevention email content
 
   @regression
   @bwedd_fil_322_25_fedfil_fraud_prevention
   @bwedd_fil_322
   Scenario: Verify Email content for template bwedd_fil_322_25_fedfil_fraud_prevention
    Given i trigger "bwedd_fil_322_25_fedfil_fraud_prevention" input through csp testemail
