Feature: Verify fedfil_bops_order_notification 264_14S_BWEDD email content

  @regression
  @bwedd_fil_264_14S_fedfil_bops_order_notification
  @bwedd_fil_264
  Scenario: Verify email content for template bwedd_fil_264_14S_fedfil_bops_order_notification
    Given i trigger "bwedd_fil_264_14S_fedfil_bops_order_notification" input through csp testemail
