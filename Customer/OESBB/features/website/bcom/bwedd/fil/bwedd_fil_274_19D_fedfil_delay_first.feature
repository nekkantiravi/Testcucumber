Feature: Verify BWEDD 274 fedfil delay first email content
  ...
  @regression
  @bwedd_fil_274_19D_fedfil_delay_first
  Scenario: Verify email content for template bwedd_fil_274_19D_fedfil_delay_first
    Given i trigger "bwedd_fil_274_19D_fedfil_delay_first" input through csp testemail
