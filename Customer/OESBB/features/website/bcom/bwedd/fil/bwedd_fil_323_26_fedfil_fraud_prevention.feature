 Feature: Verify BWEDD 323 fedfil fraud prevention email content
 
   @regression
   @bwedd_fil_323_26_fedfil_fraud_prevention
   @bwedd_fil_323
   Scenario: Verify Email content for template bwedd_fil_323_26_fedfil_fraud_prevention
    Given i trigger "bwedd_fil_323_26_fedfil_fraud_prevention" input through csp testemail
