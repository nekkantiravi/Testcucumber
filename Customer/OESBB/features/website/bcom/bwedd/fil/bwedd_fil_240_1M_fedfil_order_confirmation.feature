 Feature: Verify BCOM 240 order confirmation email content
   ...
   @regression
   @bwedd_fil_240_1M_fedfil_order_confirmation
   @bwedd_fil_240
   Scenario: Verify Email content for template bwedd_fil_240_1M_fedfil_order_confirmation
    Given i trigger "bwedd_fil_240_1M_fedfil_order_confirmation" input through csp testemail
	...
	And i should see "THIS ORDER IS A GIFT" text
	  ...
	  @bwedd_fil_240_1M_fedfil_order_confirmation_EGC65_Visa_payments   @regression
  Scenario: Verify Email content for template bwedd_fil_240_1M_fedfil_order_confirmation_EGC65_Visa_payments
    Given i trigger "bwedd_fil_240_1M_fedfil_order_confirmation_EGC65_Visa_payments" input through csp testemail
    And i have an enhanced payload sent to email provider
    When i navigate to view the email page
    And i should see bloomingdales registry logo
    And i should see freeshipping image
