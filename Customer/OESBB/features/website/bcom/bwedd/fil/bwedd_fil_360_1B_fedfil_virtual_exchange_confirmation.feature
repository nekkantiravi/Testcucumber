Feature: Verify fedfil virtual exchange confirmation templates
  ...
  @regression
  @bwedd_fil_360_1B_fedfil_virtual_exchange_confirmation
  Scenario: Verify email content for template bwedd_fil_360_1B_fedfil_virtual_exchange_confirmation
    Given i trigger "bwedd_fil_360_1B_fedfil_virtual_exchange_confirmation" input through csp testemail
