Feature: Verify fed fil split ship email content
  ...
  @bwedd_fil_540_1M_fedfil_split_ship_confirmation_shoprunner_shipping @regression @bwedd_fil_360 @bwedd_fill_540_SR
  Scenario: Verify email content for template bwedd_fil_540_1M_fedfil_split_ship_confirmation_shoprunner_shipping
    Given i trigger "bwedd_fil_540_1M_fedfil_split_ship_confirmation_shoprunner_shipping" input through csp testemail
