 Feature: Verify BCOM 240 order confirmation email content
   ...
   @regression
   @bwedd_fil_240_1M_fedfil_order_confirmation_shoprunner_shipping
   @bwedd_fil_240
   Scenario: Verify Email content for template bwedd_fil_240_1M_fedfil_order_confirmation
    Given i trigger "bwedd_fil_240_1M_fedfil_order_confirmation_shoprunner_shipping" input through csp testemail
