Feature: Verify fed fil split ship email content
  ...
  @bwedd_fil_540_1M_fedfil_split_ship_confirmation
  @regression
  @bwedd_fil_360
  Scenario: Verify email content for template bwedd_fil_540_1M_fedfil_split_ship_confirmation
    Given i trigger "bwedd_fil_540_1M_fedfil_split_ship_confirmation" input through csp testemail
