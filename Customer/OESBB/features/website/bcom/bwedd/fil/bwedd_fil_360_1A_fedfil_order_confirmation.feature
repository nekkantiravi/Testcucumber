Feature: Verify fedfil order confirmation templates
  ...
  @bwedd_fil_360_1A_fedfil_order_confirmation 
  @regression
  @bwedd_fil_360
  Scenario: Verify email content for template bwedd_fil_360_1A_fedfil_order_confirmation
    Given i trigger "bwedd_fil_360_1A_fedfil_order_confirmation" input through csp testemail
    ...
    And i should see product details
   	 ...
   	 @bwedd_fil_360_1A_fedfil_order_confirmation_email_shipping @regression
    Scenario: Verify Email content for template bwedd_fil_360_1A_fedfil_order_confirmation_email_shipping
    Given i trigger "bwedd_fil_360_1A_fedfil_order_confirmation_email_shipping" input through csp testemail
    And i have an enhanced payload sent to email provider
    When i navigate to view the email page
    And i should see bloomingdales registry logo
    And i should see freeshipping image
