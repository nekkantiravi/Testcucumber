Feature: Verify fedfil  shipment email content
  ...
  @bwedd_fil_264_14I_fedfil_shipment_confirmation_shoprunner_shipping @regression3 @bwedd_fil_264
  Scenario: Verify email content for template bwedd_fil_264_14I_fedfil_shipment_confirmation_shoprunner_shipping
    Given i trigger "bwedd_fil_264_14I_fedfil_shipment_confirmation_shoprunner_shipping" input through csp testemail
