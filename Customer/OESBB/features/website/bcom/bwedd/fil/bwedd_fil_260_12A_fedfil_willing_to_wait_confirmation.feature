Feature: Verify BWEDD 260 willing to wait confirmation email content
  ...
  @regression @bwedd_fil_260_12A_fedfil_willing_to_wait_confirmation
  Scenario: Verify Email content for template bwedd_fil_260_12A_fedfil_willing_to_wait_confirmation
    Given i trigger "bwedd_fil_260_12A_fedfil_willing_to_wait_confirmation" input through csp testemail
