Feature: Verify BCOM fedfil cancel email content
  ...
  @bwedd_fil_268_17C_fedfil_cancel
  @regression
  Scenario: Verify email content for template bwedd_fil_268_17C_fedfil_cancel
    Given i trigger "bwedd_fil_268_17C_fedfil_cancel" input through csp testemail
