Feature: Verify fedfil shipment confirmation email content
  ...
  @bwedd_fil_264_14P_fedfil_shipment_confirmaiton_shoprunner_shipping 
  @regression
  @bwedd_fil_264
  Scenario: Verify email content for template bwedd_fil_264_14P_fedfil_shipment_confirmaiton_shoprunner_shipping
    Given i trigger "bwedd_fil_264_14P_fedfil_shipment_confirmaiton_shoprunner_shipping" input through csp testemail
