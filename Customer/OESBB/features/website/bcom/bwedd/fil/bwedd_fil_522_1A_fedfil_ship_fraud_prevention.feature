 Feature: Verify BCOM 522 fedfil ship fraud prevention email content
   ...
   @regression
   @bwedd_fil_522_1A_fedfil_ship_fraud_prevention
   @bcom_fil_522
   Scenario: Verify Email content for template bwedd_fil_522_1A_fedfil_ship_fraud_prevention
    Given i trigger "bwedd_fil_522_1A_fedfil_ship_fraud_prevention" input through csp testemail
