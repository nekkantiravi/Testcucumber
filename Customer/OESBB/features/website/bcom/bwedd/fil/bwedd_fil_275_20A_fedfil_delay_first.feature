Feature: Verify BWEDD 275 fedfil delay first email content

  @regression
  @bwedd_fil_275_20A_fedfil_delay_first
  Scenario: Verify email content for template bwedd_fil_275_20A_fedfil_delay_first
    Given i trigger "bwedd_fil_275_20A_fedfil_delay_first" input through csp testemail
    ...
    Then i should see static contents:
      """
      An item from your registry order is currently out of stock and its delivery date has been delayed. A new estimated shipping date is listed below. You will not be charged until the item ships.
      """
