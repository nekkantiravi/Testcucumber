 Feature: Verify BWEDD 324 fedfil fraud prevention email content
 
   @regression
   @bwedd_fil_324_27_fedfil_fraud_prevention
   @bwedd_fil_324
   Scenario: Verify Email content for template bwedd_fil_324_27_fedfil_fraud_prevention
    Given i trigger "bwedd_fil_324_27_fedfil_fraud_prevention" input through csp testemail
