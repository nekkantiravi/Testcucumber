Feature: Verify BWEDD 275 fedfil delay first email content
  ...
  @regression
  @bwedd_fil_275_20C_fedfil_delay_first
  Scenario: Verify email content for template bwedd_fil_275_20C_fedfil_delay_first
    Given i trigger "bwedd_fil_275_20C_fedfil_delay_first" input through csp testemail
