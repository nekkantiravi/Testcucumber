Feature: Verify fedfil shipment confirmation email content
  ...
  @bwedd_fil_264_14A_fedfil_shipment_confirmation @regression @bwedd_fil_264
  Scenario: Verify email content for template bwedd_fil_264_14A_fedfil_shipment_confirmation
    Given i trigger "bwedd_fil_264_14A_fedfil_shipment_confirmation" input through csp testemail
  ...
  @bwedd_fil_264_14A_fedfil_shipment_confirmation_email_shipping 
  @regression
  Scenario: Verify Email content for template bwedd_fil_264_14A_fedfil_shipment_confirmation_email_shipping
    Given i trigger "bwedd_fil_264_14A_fedfil_shipment_confirmation_email_shipping" input through csp testemail
    And i have an enhanced payload sent to email provider
    When i navigate to view the email page
    And i should see bloomingdales registry logo
    And i should see freeshipping image
