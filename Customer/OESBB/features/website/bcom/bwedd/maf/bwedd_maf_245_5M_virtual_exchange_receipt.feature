Feature: Verify BWEDD maf virtual exchange receipt email content

  @bwedd_maf_245_5M_virtual_exchange_receipt 
  @regression
  @bwedd_maf_245
  Scenario: Verify email content for template blcom_maf_245_5L_virtual_return_receipt
    Given i trigger "bwedd_maf_245_5M_virtual_exchange_receipt" input through csp testemail
    ...
    And i should see static contents:
      """
      We received the item that we replaced on 06/19/2016 and your return is complete.
      """
