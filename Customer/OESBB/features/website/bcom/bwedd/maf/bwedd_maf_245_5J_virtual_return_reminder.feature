Feature: Verify BCOM maf virtual return reminder email content
  ...
  @bwedd_maf_245_5J_virtual_return_reminder 
  @regression
  @bwedd_maf_245
  Scenario: Verify email content for template bwedd_maf_245_5J_virtual_return_reminder
    Given i trigger "bwedd_maf_245_5J_virtual_return_reminder" input through csp testemail
