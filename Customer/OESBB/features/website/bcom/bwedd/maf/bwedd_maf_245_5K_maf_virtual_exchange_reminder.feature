Feature: Verify BWEDD maf virtual Exchange reminder email content

  @regression
  Scenario: Verify email content for template bwedd_maf_245_5K_maf_virtual_exchange_reminder
    Given i trigger "bwedd_maf_245_5K_maf_virtual_exchange_reminder" input through csp testemail
