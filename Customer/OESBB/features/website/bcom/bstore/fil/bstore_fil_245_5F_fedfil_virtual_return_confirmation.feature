Feature: Verify BSTORE 245 virtual return confirmation email content

  @regression @bstore_fil_245_5F_fedfil_virtual_return_confirmation
  Scenario: Verify Email content for template bstore_fil_245_5F_fedfil_virtual_return_confirmation
    Given i trigger "bstore_fil_245_5F_fedfil_virtual_return_confirmation" input through csp testemail
