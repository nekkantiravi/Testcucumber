Feature: Verify fedfil shipment confirmation email content
  ...
  @bstore_fil_264_14A_fedfil_shipment_confirmation_shoprunner_shipping 
  @regression
  @bstore_fil_264
  Scenario: Verify email content for template bstore_fil_264_14A_fedfil_shipment_confirmation_shoprunner_shipping
    Given i trigger "bstore_fil_264_14A_fedfil_shipment_confirmation_shoprunner_shipping" input through csp testemail
