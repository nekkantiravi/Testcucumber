Feature: Verify BSTORE 233 1A  email content

  @bstore_fil_233_1A_payment_auth_failure @regression @bstore_fil_233
  Scenario: Verify Email content for for template bstore_fil_233_1A_payment_auth_failure
    Given i trigger "bstore_fil_233_1A_payment_auth_failure" input through csp testemail
...
#				For assistance, please call our Customer Service team at 1-800-777-0000 We’re available 24 hours a day, 7 days a week.
    ...
    #Order no is displaying instead of reservation no and due to that below step is failing.  
