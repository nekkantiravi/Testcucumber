Feature: Verify BSTORE 246 fedfil return confirmation gift to email content
  ...
  @regression @bstore_fil_246_6A_fedfil_return_confirmation_gift_to
  Scenario: Verify Email content for template blcom_fil_246_6_fedfil_return_confirmation_gift_to
    Given i trigger "bstore_fil_246_6A_fedfil_return_confirmation_gift_to" input through csp testemail
