Feature: Verify BSTORE 278 fedfil delay second email content

  @regression @bstore_fil_278_23B_fedfil_delay_second
  Scenario: Verify email content for template bstore_fil_278_23B_fedfil_delay_second
    Given i trigger "bstore_fil_278_23B_fedfil_delay_second" input through csp testemail
