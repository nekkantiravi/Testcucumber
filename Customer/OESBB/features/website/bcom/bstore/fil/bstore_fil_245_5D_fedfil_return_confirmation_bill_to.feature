Feature: Verify BSTORE 245 fedfil return confirmation bill to email content
  ...
  @regression @bstore_fil_245_5D_fedfil_return_confirmation_bill_to
  Scenario: Verify Email content for template bstore_fil_245_5D_fedfil_return_confirmation_bill_to
    Given i trigger "bstore_fil_245_5D_fedfil_return_confirmation_bill_to" input through csp testemail
    ...
    And i should see body text for return confirmation bill to:
      """
      We received your request for a refund for the merchandise listed below. A refund will be issued to you in the amount of $<orderTotals.orderTotal>. If you used a Gift Card or REWARD CARD or received the item(s) as a gift, a new card will be issued to you shortly.
      """
