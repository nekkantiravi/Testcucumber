Feature: Verify BCOM fedfil cancel email content
  ...
  @bstore_fil_266_16A_fedfil_cancel
  @regression
  Scenario: Verify email content for template bstore_fil_266_16A_fedfil_cancel
    Given i trigger "bstore_fil_266_16A_fedfil_cancel" input through csp testemail
    ...
    #Freeshipping is not displaying in the email.
