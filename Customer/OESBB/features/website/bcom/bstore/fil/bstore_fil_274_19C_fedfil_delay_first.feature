Feature: Verify BSTORE 274 fedfil delay first email content

  @regression
  @bstore_fil_274_19C_fedfil_delay_first
  Scenario: Verify email content for template bstore_fil_274_19C_fedfil_delay_first
    Given i trigger "bstore_fil_274_19C_fedfil_delay_first" input through csp testemail
    ...
    #Then i should see header:
      ...
      #"""
      # Header in email is not displaying as per mapping document
