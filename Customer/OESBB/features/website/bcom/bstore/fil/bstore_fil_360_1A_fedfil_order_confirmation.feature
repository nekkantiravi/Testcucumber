Feature: Verify fedfil order confirmation templates
  ...
  @bstore_fil_360_1A_fedfil_order_confirmation @regression @bstore_fil_360
  Scenario: Verify email content for template bstore_fil_360_1A_fedfil_order_confirmation
    Given i trigger "bstore_fil_360_1A_fedfil_order_confirmation" input through csp testemail
