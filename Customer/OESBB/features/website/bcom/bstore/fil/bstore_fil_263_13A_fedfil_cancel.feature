Feature: Verify BCOM fedfil cancel email content
  ...
  @bstore_fil_263_13A_fedfil_cancel
  @regression
  Scenario: Verify email content for template bstore_fil_263_13A_fedfil_cancel
    Given i trigger "bstore_fil_263_13A_fedfil_cancel" input through csp testemail
