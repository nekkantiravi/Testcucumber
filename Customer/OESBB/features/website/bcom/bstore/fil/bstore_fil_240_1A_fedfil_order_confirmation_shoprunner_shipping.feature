Feature: Verify fedfil order confirmation email content
  ...
  @bstore_fil_240_1A_fedfil_order_confirmation_shoprunner_shipping @regression @bstore_fil_240
  Scenario: Verify email content for template bstore_fil_240_1A_fedfil_order_confirmation_shoprunner_shipping
    Given i trigger "bstore_fil_240_1A_fedfil_order_confirmation_shoprunner_shipping" input through csp testemail
