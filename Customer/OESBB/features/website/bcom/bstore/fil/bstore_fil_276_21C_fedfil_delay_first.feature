Feature: Verify BSTORE 276 fedfil delay first email content
  ...
  @regression
  @bstore_fil_276_21C_fedfil_delay_first
  Scenario: Verify email content for template bstore_fil_276_21C_fedfil_delay_first
    Given i trigger "bstore_fil_276_21C_fedfil_delay_first" input through csp testemail
