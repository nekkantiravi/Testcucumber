Feature: Verify fedfil shipment confirmation email content
  ...
  @bstore_fil_264_14A_fedfil_shipment_confirmation 
  @regression
  @bstore_fil_264
  Scenario: Verify email content for template bstore_fil_264_14A_fedfil_shipment_confirmation
   ...
   @bstore_fil_264_14A_fedfil_shipment_confirmation_standard_shipping 
  @regression
  Scenario: Verify Email content for template bstore_fil_264_14A_fedfil_shipment_confirmation_standard_shipping 
    Given i trigger "bstore_fil_264_14A_fedfil_shipment_confirmation_standard_shipping" input through csp testemail
    And i have an enhanced payload sent to email provider
    When i navigate to view the email page
    And i should see bloomingdales logo
    And i should see freeshipping image
