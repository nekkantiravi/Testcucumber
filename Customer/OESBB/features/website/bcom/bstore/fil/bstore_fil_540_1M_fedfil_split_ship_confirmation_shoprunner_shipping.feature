Feature: Verify fed fil split ship email content
  ...
  @bstore_fil_540_1M_fedfil_split_ship_confirmation_shoprunner_shipping @regression @bstore_fil_540
  Scenario: Verify email content for template bstore_fil_540_1M_fedfil_split_ship_confirmation_shoprunner_shipping
    Given i trigger "bstore_fil_540_1M_fedfil_split_ship_confirmation_shoprunner_shipping" input through csp testemail
