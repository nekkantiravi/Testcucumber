Feature: Verify BSTORE 245 fedfil return confirmation bill to email content
  ...
  @regression @bstore_fil_245_5B_fedfil_return_confirmation_bill_to
  Scenario: Verify Email content for template bstore_fil_245_5B_fedfil_return_confirmation_bill_to
    Given i trigger "bstore_fil_245_5B_fedfil_return_confirmation_bill_to" input through csp testemail
