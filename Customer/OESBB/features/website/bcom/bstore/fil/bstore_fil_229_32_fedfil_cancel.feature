Feature: Verify BCOM fedfil cancel email content
  ...
  @bstore_fil_229_32_fedfil_cancel
  @regression
  Scenario: Verify email content for template bstore_fil_229_32_fedfil_cancel
    Given i trigger "bstore_fil_229_32_fedfil_cancel" input through csp testemail
    ...
    Then i should see static contents:
      """
      We received your exchange request for the item below; however, it's no longer available. A credit or refund will be issued to the card that was used. If you paid with a Gift Card or Loyallist Reward Card, a new Gift Card will be issued to you shortly.
      """
