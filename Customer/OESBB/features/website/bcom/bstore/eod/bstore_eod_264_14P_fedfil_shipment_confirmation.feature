Feature: Verify fedfil shipment confirmation email content
  ...
  @bstore_eod_264_14P_fedfil_shipment_confirmation @regression @bstore_eod_264
  Scenario: Verify email content for template bstore_eod_264_14P_fedfil_shipment_confirmation
    Given i trigger "bstore_eod_264_14P_fedfil_shipment_confirmation" input through csp testemail
