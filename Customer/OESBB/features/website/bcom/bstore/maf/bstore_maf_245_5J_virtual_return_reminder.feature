Feature: Verify BCOM maf virtual return reminder email content
  ...
  @bstore_maf_245_5J_virtual_return_reminder 
  @regression
  @bstore_maf_245
  Scenario: Verify email content for template bstore_maf_245_5J_virtual_return_reminder
    Given i trigger "bstore_maf_245_5J_virtual_return_reminder" input through csp testemail
  ...
  @production
  Scenario: Production : Verify email template for bstore_maf_245_5J_virtual_return_reminder
    Given i trigger "bstore_maf_245_5J_virtual_return_reminder" input through csp testemail
    When i navigate to view the email page
