Feature: Verify BCOM 524 Pended order notification email content

@regression @blcom_eod_524_1A_pended_order
  Scenario: Verify Email content for template bcom_eod_524_1A_pended_order notification
    Given i trigger "blcom_eod_524_1A_pended_order" input through csp testemail
