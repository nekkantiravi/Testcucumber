Feature: Verify bops order notification 264_14Q_BCOM email content
  ...
  @regression
  @blcom_eod_264_14Q_fedfil_bops_order_notification
  @blcom_eod_264
  Scenario: Verify email content for template blcom_eod_264_14Q_fedfil_bops_order_notification
    Given i trigger "blcom_eod_264_14Q_fedfil_bops_order_notification" input through csp testemail
