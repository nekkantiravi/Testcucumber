Feature: Verify fedfil shipment confirmation email content
  ...
  @blcom_eod_264_14G_fedfil_shipment_confirmation @regression @blcom_eod_264
  Scenario: Verify email content for template blcom_eod_264_14G_fedfil_shipment_confirmation
    Given i trigger "blcom_eod_264_14G_fedfil_shipment_confirmation" input through csp testemail
