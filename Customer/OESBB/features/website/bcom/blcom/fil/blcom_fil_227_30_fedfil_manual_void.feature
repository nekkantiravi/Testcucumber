Feature: Verify BCOM 227 fedfil manual void email content
  ...
  @regression @blcom_fil_227_30_fedfil_manual_void @bcom_fil_227
  Scenario: Verify Email content for template blcom_fil_227_30_fedfil_manual_void
    Given i trigger "blcom_fil_227_30_fedfil_manual_void" input through csp testemail
    ...
    And i should see "CUSTOMER SERVICE" link
     ...
     @optional
  Scenario: Verify optional fields empty scenario for template blcom_fil_227_30_fedfil_manual_void
    Given i trigger "blcom_fil_227_30_fedfil_manual_void_optional" input through csp testemail
    When i navigate to view the email page
