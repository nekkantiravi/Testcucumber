 Feature: Verify BCOM 240 order confirmation email content
   ...
   @regression
   @blcom_fil_240_1H_fedfil_order_confirmation
   @blcom_fil_240
   Scenario: Verify Email content for template blcom_fil_240_1H_fedfil_order_confirmation
    Given i trigger "blcom_fil_240_1H_fedfil_order_confirmation" input through csp testemail
	...
	And i should see gift message
	   ...
	   @blcom_fil_240_1H_fedfil_order_confirmation_email_shipping @regression
    Scenario: Verify Email content for template blcom_fil_240_1H_fedfil_order_confirmation_email_shipping
    Given i trigger "blcom_fil_240_1H_fedfil_order_confirmation_email_shipping" input through csp testemail
    And i have an enhanced payload sent to email provider
    When i navigate to view the email page
    And i should see bloomingdales logo
    And i should see freeshipping image
