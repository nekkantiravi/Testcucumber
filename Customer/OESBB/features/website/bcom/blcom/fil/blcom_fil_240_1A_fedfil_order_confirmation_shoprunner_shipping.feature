Feature: Verify BCOM 240 order confirmation shoprunner shipping email content

  @regression @blcom_fil_240_1A_fedfil_order_confirmation_shoprunner_shipping
  Scenario: Verify Email content for template blcom_fil_240_1A_fedfil_order_confirmation_shoprunner_shipping
    Given i trigger "blcom_fil_240_1A_fedfil_order_confirmation_shoprunner_shipping" input through csp testemail
