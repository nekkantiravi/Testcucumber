 Feature: Verify BCOM 522 fedfil ship fraud prevention email content
   ...
   @regression
   @blcom_fil_522_1A_fedfil_ship_fraud_prevention
   @bcom_fil_522
   Scenario: Verify Email content for template blcom_fil_522_1A_fedfil_ship_fraud_prevention
    Given i trigger "blcom_fil_522_1A_fedfil_ship_fraud_prevention" input through csp testemail
    ...
    @optional
    Scenario: Verify optional fields empty scenario for template blcom_fil_522_1A_fedfil_ship_fraud_prevention_optional
    Given i trigger "blcom_fil_522_1A_fedfil_ship_fraud_prevention_optional" input through csp testemail
    When i navigate to view the email page
    And i should see bloomingdales logo