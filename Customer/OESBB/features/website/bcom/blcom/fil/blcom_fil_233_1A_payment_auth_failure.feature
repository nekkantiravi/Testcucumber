Feature: Verify BCOM 233 1A  email content

  @blcom_fil_233_1A_payment_auth_failure @regression @bcom_fil_233
  Scenario: Verify Email content for for template blcom_fil_233_1A_payment_auth_failure
    Given i trigger "blcom_fil_233_1A_payment_auth_failure" input through csp testemail
