Feature: Verify BCOM fedfil cancel email content
  ...
  @blcom_fil_268_17A_fedfil_cancel
  @regression222
  Scenario: Verify email content for template blcom_fil_268_17A_fedfil_cancel
    Given i trigger "blcom_fil_268_17A_fedfil_cancel" input through csp testemail
