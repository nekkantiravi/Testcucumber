Feature: Verify fedfil bops order notification bcom_264_14T email content
  ...
  @regression
  @blcom_fil_264_14T_fedfil_bops_order_notification
  @blcom_fil_264
  Scenario: Verify email content for template blcom_fil_264_14T_fedfil_bops_order_notification
    Given i trigger "blcom_fil_264_14T_fedfil_bops_order_notification" input through csp testemail
