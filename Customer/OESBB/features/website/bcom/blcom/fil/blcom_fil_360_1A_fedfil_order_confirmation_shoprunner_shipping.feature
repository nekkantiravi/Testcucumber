Feature: Verify fedfil order confirmation templates
  ...
  @regression @blcom_fil_360_1A_fedfil_order_confirmation_shoprunner_shipping @blcom_fil_360
  Scenario: Verify email content for template blcom_fil_360_1A_fedfil_order_confirmation
    Given i trigger "blcom_fil_360_1A_fedfil_order_confirmation_shoprunner_shipping" input through csp testemail
