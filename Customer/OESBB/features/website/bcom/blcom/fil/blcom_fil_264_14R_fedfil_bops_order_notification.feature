Feature: Verify fedfil bops order notification 264_14R_BCOM email content

  @regression
  @blcom_fil_264_14R_fedfil_bops_order_notification
  @blcom_fil_264
  Scenario: Verify email content for template blcom_fil_264_14R_fedfil_bops_order_notification
    Given i trigger "blcom_fil_264_14R_fedfil_bops_order_notification" input through csp testemail
