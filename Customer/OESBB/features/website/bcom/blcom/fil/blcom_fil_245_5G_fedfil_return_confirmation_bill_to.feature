Feature: Verify BCOM 245 fedfil return confirmation bill to email content
  ...
  @regression @blcom_fil_245_5G_fedfil_return_confirmation_bill_to
  Scenario: Verify Email content for template blcom_fil_245_5G_fedfil_return_confirmation_bill_to
    Given i trigger "blcom_fil_245_5G_fedfil_return_confirmation_bill_to" input through csp testemail
