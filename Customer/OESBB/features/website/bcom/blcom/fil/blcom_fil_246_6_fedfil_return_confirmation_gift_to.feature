Feature: Verify BWEDD 246 fedfil return confirmation gift to email content
  ...
  @regression @blcom_fil_246_6_fedfil_return_confirmation_gift_to
  Scenario: Verify Email content for template blcom_fil_246_6_fedfil_return_confirmation_gift_to
    Given i trigger "blcom_fil_246_6_fedfil_return_confirmation_gift_to" input through csp testemail
