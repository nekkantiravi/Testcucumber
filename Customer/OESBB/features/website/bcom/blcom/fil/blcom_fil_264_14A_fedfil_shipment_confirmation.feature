Feature: Verify fedfil shipment confirmation email content
  ...
  @regression @blcom_fil_264_14A_fedfil_shipment_confirmation
  Scenario: Verify email content for template blcom_fil_264_14A_fedfil_shipment_confirmation
    Given i trigger "blcom_fil_264_14A_fedfil_shipment_confirmation" input through csp testemail
  ...
  @blcom_fil_264_14A_fedfil_shipment_confirmation_multiple_tracking_urls 
  @regression
  Scenario: Verify Email content for template blcom_fil_264_14A_fedfil_shipment_confirmation_multiple_tracking_urls
    Given i trigger "blcom_fil_264_14A_fedfil_shipment_confirmation_multiple_tracking_urls" input through csp testemail
    And i have an enhanced payload sent to email provider
    When i navigate to view the email page
    And i should see bloomingdales logo
    And i should see freeshipping image
