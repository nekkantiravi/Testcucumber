Feature: Verify BCOM 276 fedfil delay first email content
  ...
  @regression
  @blcom_fil_276_21A_fedfil_delay_first
  Scenario: Verify email content for template blcom_fil_276_21A_fedfil_delay_first
    Given i trigger "blcom_fil_276_21A_fedfil_delay_first" input through csp testemail
