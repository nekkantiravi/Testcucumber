Feature: Verify fedfil_bops_order_notification 264_14S_BLCOM email content
  ...
  @regression
  @blcom_fil_264_14S_fedfil_bops_order_notification
  @blcom_fil_264
  Scenario: Verify email content for template blcom_fil_264_14S_fedfil_bops_order_notification
    Given i trigger "blcom_fil_264_14S_fedfil_bops_order_notification" input through csp testemail
