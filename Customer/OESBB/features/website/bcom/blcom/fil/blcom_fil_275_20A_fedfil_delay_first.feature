Feature: Verify BCOM 275 fedfil delay first email content

  @regression
  @blcom_fil_275_20A_fedfil_delay_first
  Scenario: Verify email content for template blcom_fil_275_20A_fedfil_delay_first
    Given i trigger "blcom_fil_275_20A_fedfil_delay_first" input through csp testemail
