Feature: Verify fed fil split ship email content
  ...
  @blcom_fil_540_1H_fedfil_split_ship_confirmation @regression @blcom_fil_540
  Scenario: Verify email content for template blcom_fil_540_1H_fedfil_split_ship_confirmation
    Given i trigger "blcom_fil_540_1H_fedfil_split_ship_confirmation" input through csp testemail
