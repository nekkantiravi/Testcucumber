Feature: Verify fedfil virtual exchange confirmation templates
  ...
  @regression @blcom_fil_360_1B_fedfil_virtual_exchange_confirmation
  Scenario: Verify email content for template blcom_fil_360_1B_fedfil_virtual_exchange_confirmation
    Given i trigger "blcom_fil_360_1B_fedfil_virtual_exchange_confirmation" input through csp testemail
  ...
  @optional
  Scenario: Verify optional fields empty scenario for template blcom_fil_360_1B_fedfil_virtual_exchange_confirmation
    Given i trigger "blcom_fil_360_1B_fedfil_virtual_exchange_confirmation_optional" input through csp testemail
    When i navigate to view the email page
