Feature: Verify BCOM 278 fedfil delay second email content
  ...
  @regression @blcom_fil_278_23B_fedfil_delay_second
  Scenario: Verify email content for template blcom_fil_275_23B_fedfil_delay_second
    Given i trigger "blcom_fil_278_23B_fedfil_delay_second" input through csp testemail
    ...
    @optional
    Scenario: Verify optional fields empty scenario for template blcom_fil_278_23B_fedfil_delay_second
    Given i trigger "blcom_fil_278_23B_fedfil_delay_second_optional" input through csp testemail
    When i navigate to view the email page
    And i should see bloomingdales logo
