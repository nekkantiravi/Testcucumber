Feature: Verify fedfil shipment confirmation email content
  ...
  @blcom_fil_264_14K_fedfil_shipment_confirmation @regression @blcom_fil_264
  Scenario: Verify email content for template blcom_fil_264_14K_fedfil_shipment_confirmation
    Given i trigger "blcom_fil_264_14K_fedfil_shipment_confirmation" input through csp testemail
  ...
  @blcom_fil_264_14K_fedfil_shipment_confirmation_standard_shipping 
  @regression
  Scenario: Verify Email content for template blcom_fil_264_14K_fedfil_shipment_confirmation_standard_shipping
    Given i trigger "blcom_fil_264_14K_fedfil_shipment_confirmation_standard_shipping" input through csp testemail
    And i have an enhanced payload sent to email provider
    When i navigate to view the email page
    And i should see bloomingdales logo
    And i should see freeshipping image
