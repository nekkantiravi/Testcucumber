Feature: Verify BCOM 260 willing to wait confirmation email content
  ...
  @regression @blcom_fil_260_12B_fedfil_willing_to_wait_confirmation
  Scenario: Verify Email content for template blcom_fil_260_12B_fedfil_willing_to_wait_confirmation
    Given i trigger "blcom_fil_260_12B_fedfil_willing_to_wait_confirmation" input through csp testemail
