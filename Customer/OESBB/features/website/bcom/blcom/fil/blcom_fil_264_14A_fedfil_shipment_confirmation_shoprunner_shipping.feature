Feature: Verify fedfil shipment confirmation email content
  ...
  @regression @blcom_fil_264_14A_fedfil_shipment_confirmation_shoprunner_shipping
  Scenario: Verify email content for template blcom_fil_264_14A_fedfil_shipment_confirmation_shoprunner_shipping
    Given i trigger "blcom_fil_264_14A_fedfil_shipment_confirmation_shoprunner_shipping" input through csp testemail
