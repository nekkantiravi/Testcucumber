Feature: Verify fedfil shipment confirmation email content
  ...
  @blcom_fil_264_14B_fedfil_shipment_confirmation_shoprunner_shipping 
  @regression
  @blcom_fil_264
  Scenario: Verify email content for template  blcom_fil_264_14B_fedfil_shipment_confirmation_shoprunner_shipping
    Given i trigger "blcom_fil_264_14B_fedfil_shipment_confirmation_shoprunner_shipping" input through csp testemail
