Feature: Verify BCOM fedfil cancel email content
  ...
  @blcom_fil_266_16A_fedfil_cancel
  @regression
  Scenario: Verify email content for template blcom_fil_266_16A_fedfil_cancel
    Given i trigger "blcom_fil_266_16A_fedfil_cancel" input through csp testemail
