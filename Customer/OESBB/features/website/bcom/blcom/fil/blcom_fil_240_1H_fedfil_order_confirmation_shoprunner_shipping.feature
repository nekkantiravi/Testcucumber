 Feature: Verify BCOM 240 order confirmation email content
   ...
   @regression
   @blcom_fil_240_1H_fedfil_order_confirmation_shoprunner_shipping
   @blcom_fil_240
   Scenario: Verify Email content for template blcom_fil_240_1H_fedfil_order_confirmation_shoprunner_shipping
    Given i trigger "blcom_fil_240_1H_fedfil_order_confirmation_shoprunner_shipping" input through csp testemail
