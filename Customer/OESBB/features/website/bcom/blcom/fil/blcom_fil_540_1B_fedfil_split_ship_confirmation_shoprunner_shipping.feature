Feature: Verify fed fil split ship email content
  ...
  @blcom_fil_540_1B_fedfil_split_ship_confirmation_shoprunner_shipping @regression @blcom_fil_540
  Scenario: Verify email content for template blcom_fil_540_1B_fedfil_split_ship_confirmation_shoprunner_shipping
    Given i trigger "blcom_fil_540_1B_fedfil_split_ship_confirmation_shoprunner_shipping" input through csp testemail
