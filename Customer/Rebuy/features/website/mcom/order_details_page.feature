...
Feature: Verify the functionality of rebuy button for eligible products in order history page and order details page
  ...
  Scenario Outline: Verify "buy again" button visible on Order details page as a signed user
    ...
    And I associate rebuy "<order_status>" order in db
  ...
  @scenario4 @domain_customer @use_project @rebuy_da @use_regression
  ...
  @scenario5 @domain_customer @use_project @rebuy_da @use_regression
  ...
  @scenario8 @domain_customer @use_project @use_regression
  ...
  @scenario9 @domain_customer @project_rebuy @b-84354 @use_project @rebuy_da
  ...
  @scenario10 @domain_customer @project_rebuy @b-84354 @use_project @rebuy_da
