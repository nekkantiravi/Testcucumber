...
# Story NO: B-77788 : CM4:: BUS::UI::Desktop::BCOM::Comp-Credit Gateway Redesign::Home Page-Signed in
# Story NO: B-90744 : SDT: BCOM Desktop Automation for Signed IN Single / Multi Card view

  @domain_customer @project_responsive_gateway @release_17O
