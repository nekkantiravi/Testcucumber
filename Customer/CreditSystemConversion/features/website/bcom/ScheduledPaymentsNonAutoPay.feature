...
#        B-88842 :: OTSP2: BUS:: BCOM:: Conditional Deeplink name "Enroll in Autopay" or  "Manage Autopay"
# Author: QE Team
############################################################################
...
#       3.Feature will be Wrapped under Kill Switch: creditSchedulePaymentEnabled=true
  ...
  Scenario: User should not have any schedule payments
    Given I sign in with user having "single_card_n" added in profile
  ...
  Scenario: User having single card with single scheduled payment
    Given I sign in with user having "single_card_ss" added in profile
    When I navigate to the "credit services" page from footer
  ...
  Scenario: User having single card with multiple scheduled payments
    Given I sign in with user having "single_card_ms" added in profile
    When I navigate to the "credit services" page from footer
  ...
  Scenario: User having single card with scheduled payment processing already started
    Given I sign in with user having "single_card_ps" added in profile
    When I navigate to the "credit services" page from footer
  ...
  Scenario: User having multiple cards and multi scheduled payments for all cards
    Given I sign in with user having "multi_card_ms_all" added in profile
    When I navigate to the "credit services" page from footer
    Then I should see "ms_payment_message" on schedule payment section
  ...
  @wip @domain_customer @artifact_shopapp @project_otsp @release_
  Scenario: User having multiple cards and single scheduled payment for all cards
    Given I sign in with user having "multi_card_ss_all" added in profile
    When I navigate to the "credit services" page from footer
    Then I should see "ss_payment_message" on schedule payment section
    When I should see next card using right carousel
    Then I should see "ss_payment_message" on schedule payment section
  ...
  @wip @domain_customer @artifact_shopapp @project_otsp @release_
  Scenario: User having multiple cards with mixed scheduled payments
    Given I sign in with user having "multi_ss_ms_mixed" added in profile
    When I navigate to the "credit services" page from footer
    Then I should see "ss_payment_message" on schedule payment section
    And I should see below sections on gateway page
      |edit_in_schedule_payment|
  ...
  Scenario: User having multiple cards and scheduled payments for default card only
    Given I sign in with user having "multi_default_ss" added in profile
    When I navigate to the "credit services" page from footer
    Then I should see "ss_payment_message" on schedule payment section
  ...
  Scenario: User dual card having scheduled payments on only one line of card
    Given I sign in with user having "dual_child_ss" added in profile
    When I navigate to the "credit services" page from footer
    Then I should see "ss_payment_message" on schedule payment section

  @wip @domain_customer @artifact_shopapp @project_otsp @release_
  Scenario: User dual card having diffent scheduled payments on two lines
    Given I sign in with user having "dual_ss_ms_mixed" added in profile
    When I navigate to the "credit services" page from footer
    Then I should see "ss_payment_message" on schedule payment section
  ...
  Scenario: User dual card having single scheduled payments on both lines
    Given I sign in with user having "dual_ss_both" added in profile
    When I navigate to the "credit services" page from footer
    Then I should see "ss_payment_message" on schedule payment section
    And I tap on "out_store_account"
    Then I should see "ss_payment_message" on schedule payment section
  ...
  Scenario: User dual card having multiple scheduled payments on both lines
    Given I sign in with user having "dual_ms_both" added in profile
    When I navigate to the "credit services" page from footer
    Then I should see "ms_payment_message" on schedule payment section
    And I tap on "out_store_account"
    Then I should see "ms_payment_message" on schedule payment section
  ...
  @wip @domain_customer @artifact_shopapp @project_otsp @release_
  Scenario Outline: Verify Autopay related deeplink for user with 'Scheduled Payment' enabled that is NOT an auto payment
    Given I sign in with user having "<single_card>" added in profile
    When I navigate to the "credit services" page from footer
    Then I should see 'Enroll in Autopay' in deeplinks
    Examples:
      | single_card            |
      | single_card_ss_enabled |
      | single_card_ps_enabled |
      | single_card_ms_enabled |
      | single_card_no_scheduled_payment |