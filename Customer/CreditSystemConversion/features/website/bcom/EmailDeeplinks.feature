#########################################################
##Author:: QE Team
## Feature file includes B-43050, B-79887 stories
#########################################################
 ...
 Feature: As an online customer, I would like to not be interrupted by a speedbump when leaving Macy's to go to Citi for credit servicing to streamline my credit servicing experience.
   ...
   Scenario Outline: Verification of email deep links as a signedin user has card in profile
     ...
     Examples:
       ...
       | /creditservice/bmarknemail?linkProc=email&processIndicator=dashboard&cm_mmc=BCOM-_-citiOps-_-viewYourAccount-_-n&uID=1234567890123456  | dashboard                  |
       | /creditservice/bmarknemail?linkProc=email&processIndicator=makepaymentoptions&cm_mmc=BCOM-_-citiOps-_-payBill-_-n&uID=1234567890123456 | makepaymentoptions         |
       | /creditservice/bmarknemail?linkProc=email&processIndicator=helpcontact&cm_mmc=BCOM-_-citiOps-_-contactUs-_-n&uID=1234567890123456      | helpcontact                |
       | /creditservice/bmarknemail?linkProc=email&processIndicator=securemessage&cm_mmc=BCOM-_-citiOps-_-contactUs-_-n&uID=1234567890123456    | securemessage              |
       | /creditservice/bmarknemail?linkProc=email&processIndicator=dashboard&cm_mmc=BCOM-_-citiOps-_-viewYourAccount-_-n&uID=1234567890123456  | dashboard                  |
   ...
   Scenario Outline: Verification of email deep links as a signed in user with no card
     ...
     Examples:
       ...
       | /creditservice/bmarknemail?linkProc=email&processIndicator=dashboard&cm_mmc=BCOM-_-citiOps-_-viewYourAccount-_-n&uID=1234567890123456  |
       | /creditservice/bmarknemail?linkProc=email&processIndicator=makepaymentoptions&cm_mmc=BCOM-_-citiOps-_-payBill-_-n&uID=1234567890123456 |
       | /creditservice/bmarknemail?linkProc=email&processIndicator=helpcontact&cm_mmc=BCOM-_-citiOps-_-contactUs-_-n&uID=1234567890123456      |
       | /creditservice/bmarknemail?linkProc=email&processIndicator=securemessage&cm_mmc=BCOM-_-citiOps-_-contactUs-_-n&uID=1234567890123456    |
       | /creditservice/bmarknemail?linkProc=email&processIndicator=dashboard&cm_mmc=BCOM-_-citiOps-_-viewYourAccount-_-n&uID=1234567890123456  |
