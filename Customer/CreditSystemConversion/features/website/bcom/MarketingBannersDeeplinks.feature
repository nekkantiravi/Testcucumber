...
Feature: As an online customer, I would like to not be interrupted by a speedbump when leaving Macy's to go to Citi for credit servicing to streamline my credit servicing experience.
  ...
  Scenario Outline: Verification of marketing banner deep links as a signedin user has card in profile
    ...
    Examples:
      ...
      | /creditservice/bmarknemail?linkProc=marketingbanner&processIndicator=paperless&cm_mmc=EML2-_-citiOps-_-goPaperlessNow-_-n    | paperless                  |
      | /creditservice/bmarknemail?linkProc=marketingbanner&processIndicator=creditlineincrease&cm_mmc=EML2-_-citiOps-_-CLI-_-n      | creditlineincrease         |
      | /creditservice/bmarknemail?linkProc=marketingbanner&processIndicator=addauthusers&cm_mmc=EML2-_-citiOps-_-addauthuser-_-n    | addauthusers               |
      | /creditservice/bmarknemail?linkProc=marketingbanner&processIndicator=incomecapture&cm_mmc=EML2-_-citiOps-_-incomecapture-_-n | incomecapture              |
      | /creditservice/bmarknemail?linkProc=marketingbanner&processIndicator=verify&cm_mmc=EML2-_-citiOps-_-activatecard-_-n         | verify                     |
  ...
  Scenario Outline: Verification of marketing banner deep links as a signed in user with no card
    ...
    Examples:
      ...
      | /creditservice/bmarknemail?linkProc=marketingbanner&processIndicator=paperless&cm_mmc=EML2-_-citiOps-_-goPaperlessNow-_-n    |
      | /creditservice/bmarknemail?linkProc=marketingbanner&processIndicator=creditlineincrease&cm_mmc=EML2-_-citiOps-_-CLI-_-n      |
      | /creditservice/bmarknemail?linkProc=marketingbanner&processIndicator=addauthusers&cm_mmc=EML2-_-citiOps-_-addauthuser-_-n    |
      | /creditservice/bmarknemail?linkProc=marketingbanner&processIndicator=incomecapture&cm_mmc=EML2-_-citiOps-_-incomecapture-_-n |

  @domain_customer @project_credit_service @artifact_shopapp @release_17J
  Scenario: Verification of activate carrd marketing banner deep links as a guest user
    Given I visit the web site as a guest user
    When I open "/creditservice/bmarknemail?linkProc=marketingbanner&processIndicator=verify&cm_mmc=EML2-_-citiOps-_-activatecard-_-n" through url
    Then I should redirect to "citi_fusion" page
  ...
  Scenario Outline: Verification of marketing banner deep links as a signed in user with invalid/ missing process indicator
    ...
    Examples:
      | citi_email_deep_link                                                                                            | expected_process_indicator |
      | /creditservice/bmarknemail?linkProc=marketingbanner&processIndicator=&cm_mmc=EL2-_-citiOps-_-goPaperlessNow-_-n | dashboard                  |
      | /creditservice/bmarknemail?linkProc=marketingbanner&processIndicator=ncrease&cm_mmc=EL2-_-citiOps-_-CLI-_-n     | dashboard                  |
