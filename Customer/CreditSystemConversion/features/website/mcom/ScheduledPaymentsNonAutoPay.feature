##########################################################################
# Story: B-89405 :: OTSP2:: BUS:: MCOM:: UI:: MEW/Desktop:: CG:: Display NON-Autopay instances of Scheduled Payment data
...
#       3.Feature will be Wrapped under Kill Switch: creditSchedulePaymentEnabled=true
  ...
  @wip @domain_customer @artifact_shopapp @project_otsp @release_
  Scenario: User dual card having scheduled payments on both lines
