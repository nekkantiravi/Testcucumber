#####################################################################################
# Story             : B-79883 : BUS:: UI:: MCOM:: Desktop::M/BCOM::SDT Migration::Profile
#
...
Feature: Create Profile removal and Edit Profile removal
  ...
  @domain_customer @artifact_shopapp @release_15K
  ...
  # Removing the below scenarios as one time overlay is no longer available on MCOM
