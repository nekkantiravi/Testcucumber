#####################################################################################
# Story             : B-65894 : T-N::UI::MCOM::Desktop::Disable Card Edit in Wallet for New Cobrand Card
#                   : B-65895 : QE:: T-N::MOCK::UI::MCOM::Desktop::Enable Card Edit in Wallet for New Cobrand Card if Kill Switch = False (TEST ONLY)
#                   : B-65897 : QE:: T-N::MOCK::UI::MCOM::Desktop::Enable Card Edit in Wallet for New Cobrand Card if Account Open > 14 Days (TEST ONLY)
