#####################################################################################
# Story             : B-69168 : TC::BUS::UI::MEW::BCOM::Guest User Adds New Card to Wallet
# Author            : Credit Systems Conversion Carryover :: QE Team
#####################################################################################

Feature: As a guest user, I want to see a message prompting me to sign in/create an account when I return to bloomingdales.com Mobile (App, MEW) after completing a credit card application, receiving approval AND selecting add card to wallet, so that my card will be added to my wallet.
...
#Feature be wrapped in kill switch:  creditAddCardToWalletEnabled
 ...
 Scenario: verify that guest user should add his new card in wallet via the Fusion acquisition flow by signing into his account
   ...
   When I return to .com site by clicking on return to bloomingdales
