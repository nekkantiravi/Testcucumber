Feature: About Page Guest User Manage subscription Feature

  @guestUserAboutManageSubscription
  Scenario Outline: Program status with SUBSCRIBE NOW and BB user with no status should see error message when user visits BB page as a guest user
    ...
    |cleanup.sql|SUBSCRIBE NOW|6     |10         |Sorry, you're currently not a subscriber.|
  ...
  @guestUserAboutManageSubscription0
  ...
  @guestUserAboutManageSubscription1
  ...
  @guestUserAboutManageSubscription2
