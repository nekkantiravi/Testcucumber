...
Feature: Verify MSH basic smoke functionality
  ...
  @use_msh_smoke @use_prod @dca_dal @msh_priority1
  Scenario Outline: Verify basic functionality of dynamic landing page with DCA cookie as DAL
    Given I visit the web site as a guest user
    When I navigate to dynamic landing page in <root> mode with DCA cookie as DAL
    Then I verify that page is served from "DAL" DC
    When I select any random facet in facet panel
    Then I verify products are filtered per the selected facet
    When I select "Price: High to Low" in sort by drop down
  ...
  @use_msh_smoke @use_prod @dca_rtp @msh_priority2
  Scenario Outline: Verify basic functionality of dynamic landing page with DCA cookie as RTP
    Given I visit the web site as a guest user
    When I navigate to dynamic landing page in <root> mode with DCA cookie as RTP
    Then I verify that page is served from "RTP" DC
    When I select any random facet in facet panel
    Then I verify products are filtered per the selected facet
    When I select "Price: High to Low" in sort by drop down
  ...
  @use_msh_smoke @use_prod @without_dca_cookie @msh_priority3
  Scenario Outline: Verify basic functionality of dynamic landing page without dca cookie
    Given I visit the web site as a guest user
    When I navigate to dynamic landing page in <root> mode without dca cookie
    When I select any random facet in facet panel
    Then I verify products are filtered per the selected facet
    When I select "Price: High to Low" in sort by drop down
    Then I verify that product display order modified
