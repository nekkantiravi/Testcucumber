...
Feature: Tabbed view of online and BOPS items on Browse pages
  ...
  Scenario: Verify the default tabbed view of Online and BOPS items on browse page.
    Given I am on Home Page
    When I select "Women" FOB
    And I select "Dresses" category
    And I navigate to browse page
    And I should see tabbed view for online and BOPS items
    Then I should see "All products" tab as active
    And I should see "Local store" tab as inactive

  @project_IA_2017 @domain_discovery @scenario2
  Scenario: Verify the product count displaying on tabbed view of Online and BOPS items on searchResults page.
    Given I am on Home Page
  ...
  Scenario: Verify that "Free Pick Up In Store" facet section is not displaying on left navigation of browse page.
    Given I am on Home Page
    When I select "Women" FOB
    And I select "Dresses" category
    And I navigate to browse page
    And I should see tabbed view for online and BOPS items
    Then I should not see "Free Pick Up In Store" facet section on left navigation of browse page

  @project_IA_2017 @domain_discovery @scenario4
  Scenario: Verify "Local store" tab when customer location is known and product results are available on browse page
    Given I am on Home Page
    When I enter "Dresses" keyword on serch text field
    And I navigate to searchResults page
  ...
  Scenario:Verify when customer select different store in "Find Stores within" overlay when default store is displayed with product result in local store tab on browse page.
    Given I am on Home Page
    When I enter "Dresses" keyword on serch text field
    And I navigate to searchResults page
    And I see tabbed view for online and BOPS items
    ...
    And I should see the newly selected store name displayed on browse page
    And I should see Change store link beside the store name on browse page

  @project_IA_2017 @domain_discovery @scenario6
  Scenario: Verify when customer click "Change location" link in "Find Stores within" overlay when default store is displayed with product result in local store tab on browse page.
    Given I am on Home Page
    When I enter "Dresses" keyword on serch text field
    And I navigate to searchResults page
    And I see tabbed view for online and BOPS items
    ...
    Then I should able to see the previou default store name on browse page

  @project_IA_2017 @domain_discovery @scenario7
  Scenario: Verify when customer selects different location in "Find a store" overlay when default store is displayed with product result in local store tab on browse page.
    Given I am on Home Page
    When I enter "Dresses" keyword on serch text field
    And I navigate to searchResults page
    And I see tabbed view for online and BOPS items
    ...
    Then I should able to see the new store name on browse page
    And I  see BOPS products in the browse page
    And I see product resuts are same from the service response

  @project_IA_2017 @domain_discovery @scenario8
  Scenario: Verify the store location tab after switch between "All products" tab and "Local store" tab when customer selects different location in "Find a store" overlay when default store is displayed with product result in local store tab on browse page.
    Given I am on Home Page
    When I enter "Dresses" keyword on serch text field
    And I navigate to searchResults page
    And I see tabbed view for online and BOPS items
  ...
  Scenario: Verify the default Local store tab when customer's location is already known but products are not available in that store on browse page
    Given I am on Home Page
    When I enter "Dresses" keyword on serch text field
    And I navigate to searchResults page
    And I see tabbed view for online and BOPS items
    ...
    And I should see the message as below:
      | We found results for dresses available for pick up at Store name |
  ...
  Scenario: Verify change store link when customer's location is already known but products are not available in that store on browse page
    Given I am on Home Page
    When I enter "Dresses" keyword on serch text field
    And I navigate to searchResults page
    And I see tabbed view for online and BOPS items
    ...
    And I should see the message as below:
      | MCOM | We found results for dresses available for pick up at:Store name |
  ...
  Scenario: Verify "Change your local store" link when customer's location is already known but products are not available in that store on search results page
    ...
    And I should see the product results on the browse page

  @project_IA_2017 @domain_discovery @scenario13
  Scenario: Verify the store location tab after switch between "All products" tab and "Local store" tab when customer's location is not known on browse page.
    Given I am on Home Page
    When I enter "Dresses" keyword on serch text field
    And I navigate to searchResults page
    And I see tabbed view for online and BOPS items
    ...
    And I see the product results in the search results page
    When I click on "Local store" tab
    Then I should able to see the same store name on browse page
    And I should see "Change store" link
