 ...
 */
public class JsonHtmlElementLocatorFactory implements CustomElementLocatorFactory {

    private final SearchContext searchContext;

    public JsonHtmlElementLocatorFactory(SearchContext searchContext) {
    ...
    public ElementLocator createLocator(Field field) {
        return new AjaxElementLocator(searchContext, getTimeOut(field), new JsonHtmlElementFieldAnnotationsHandler(field));
    }
    ...
    public ElementLocator createLocator(Class clazz) {
        ...
        return new AjaxElementLocator(searchContext, getTimeOut(clazz), new JsonHtmlElementClassAnnotationsHandler(clazz));
    }
