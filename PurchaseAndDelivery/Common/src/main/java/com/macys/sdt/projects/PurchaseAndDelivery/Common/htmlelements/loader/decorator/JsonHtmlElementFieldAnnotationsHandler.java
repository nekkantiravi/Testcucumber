...
public class JsonHtmlElementFieldAnnotationsHandler extends Annotations {
    ...
    private By buildByFromFindAnnotations() {
        if (getField().isAnnotationPresent(com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindBys.class)) {
            com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindBys findBys = getField().getAnnotation(com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindBys.class);
        ...
        if (getField().isAnnotationPresent(com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindAll.class)) {
            com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindAll findAll = getField().getAnnotation(com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindAll.class);
        ...
        if (getField().isAnnotationPresent(com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindBy.class)) {
            com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindBy findBy = getField().getAnnotation(com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindBy.class);
        ...
        if (declaringClass.isAnnotationPresent(com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindBy.class)
                && (isWebElement(getField()) || isWebElementList(getField()))) {
            String jsonPath = declaringClass.getAnnotation(com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindBy.class).jsonPath();
    ...
    private By[] findBysToBys(com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindBy[] findByArray) {
        List<By> bys = new ArrayList<>();
        for (com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindBy findBy : findByArray) {
    ...
    private By buildByFromHtmlElementAnnotations() {
        ...
        while (fieldClass != Object.class) {
            if (fieldClass.isAnnotationPresent(com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindBy.class)) {
                return jsonPathToBy(fieldClass.getAnnotation(com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindBy.class).jsonPath());
            }
    ...
    private By buildByFromHtmlElementListAnnotations() {
        ...
        while (listParameterClass != Object.class) {
            if (listParameterClass.isAnnotationPresent(com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindBy.class)) {
                return jsonPathToBy(listParameterClass.getAnnotation(com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindBy.class).jsonPath());
            }
    ...
    protected void assertValidAnnotations() {
        FindBys findBys = getField().getAnnotation(FindBys.class);
        com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindBys jsonFindBys = getField().getAnnotation(com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindBys.class);
        FindAll findAll = getField().getAnnotation(FindAll.class);
        com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindAll jsonFindAll = getField().getAnnotation(com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindAll.class);
        FindBy findBy = getField().getAnnotation(FindBy.class);
        com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindBy jsonFindBy = getField().getAnnotation(com.macys.sdt.projects.PurchaseAndDelivery.Common.htmlelements.annotations.FindBy.class);
