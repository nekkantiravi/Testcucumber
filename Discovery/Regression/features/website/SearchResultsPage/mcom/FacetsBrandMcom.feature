Feature: Facet Brand verification on Search Landing Page
  ...
  @domain_discovery @mode_domestic @mode_registry @mode_iship @snbc_comp @use_regression @migrated_to_sdt @feature_search_results_page
  ...
  @domain_discovery @mode_domestic @mode_registry @mode_iship @snbc_comp @use_regression @migrated_to_sdt @feature_search_results_page @xbrowser_search @discovery_daily_run
 ...
 # Enter a character that is not the begining of the any brand
  ...
  @domain_discovery @priority_low @mode_domestic @mode_registry @mode_iship @snbc_comp @use_regression @migrated_to_sdt @feature_search_results_page
  Scenario Outline: SearchResultsPage - Domestic|Iship|Registry - Verify error message display when no brand matches with the entered searched term
    Given I am on SearchResultsPage for "<keyword>" in <shopping_mode> mode
    And I clear existing class variable data to avoid data issues
    And I verify that "Brand" facet is listed on left nav
  ...
  @domain_discovery @priority_low @mode_iship @snbc_comp @use_regression @migrated_to_sdt @feature_search_results_page
  ...
  @domain_discovery @priority_low @mode_registry @snbc_comp @use_regression @migrated_to_sdt @feature_search_results_page
  ...
  Scenario Outline: SearchResultsPage - Domestic|Iship|Registry - Verify facet de-selection with check box under Brand facet section
    Given I am on SearchResultsPage for "cookware" in <Site_Mode> mode
    And I clear existing class variable data to avoid data issues
    Then I verify that the product count is displayed
    When I select the first brand in the Brand facet
