...
#-----------------------------
  ...
  @project_Mercandizing_facets @domain_discovery @use_regression @mode_domestic @priority_medium @B31614 @snbc_comp @migrated_to_sdt
  ...
  @project_Mercandizing_facets @use_regression @domain_discovery @mode_iship @priority_medium @B31614 @snbc_comp @migrated_to_sdt
  ...
  @test @project_Mercandizing_facets @use_regression @domain_discovery @mode_domestic @priority_medium @B32378 @snbc_comp @migrated_to_sdt
  ...
  @project_Mercandizing_facets @domain_discovery @mode_iship @priority_medium @B32378 @snbc_comp @migrated_to_sdt
  ...
  @project_Mercandizing_facets @domain_discovery @use_regression @mode_domestic @priority_medium @B33192 @snbc_comp @migrated_to_sdt
  ...
  @project_Mercandizing_facets @domain_discovery @mode_iship @priority_medium @B33192 @snbc_comp @use_regression @migrated_to_sdt
