Feature: Implement Tealium Script for Macys-node for Environment Aware for MCOM

  @Tealium_proxy
  Scenario:  Verify that tealium tags script is loaded in network call and page source on Create Registry page as a guest user
  ...
  @Tealium_proxy
  Scenario:  Verify that tealium tags script is loaded in network call on Welcome Registry and Registrant page as a guest user in mcom
    Given I visit the web site as a guest user
    When I navigate to home page for creating registry
    And I select "Create Your Registry"
  ...
  @Tealium_proxy
  Scenario:  Verify that tealium tags script is loaded in network call on Registrant as a guest user in mcom
    Given I visit the web site as a guest user
    When I navigate to home page for creating registry
    Then I click on view registry link on hover registry guide
  ...
  @Tealium_proxy
  Scenario:  Verify that tealium urls are coming in network call and page source on Create Registry page as registered user in mcom
