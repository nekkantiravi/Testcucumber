Feature:  BCOM Tag Migration Polaris Killswitch customer-preferences

  @Tealium_proxy
  Scenario Outline: Verify that tealium tags script is loaded on customer preferences page for BCOM
