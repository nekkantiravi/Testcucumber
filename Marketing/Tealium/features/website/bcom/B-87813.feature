Feature: Implement  Tealium script for Credit Gateway for BCOM

  @Tealium_proxy
  Scenario:  Verify that tealium tags script is loaded in page source and network call on Credit Gateway page for guest user
  ...
  @Tealium_proxy
  Scenario:  Verify that tealium tags script is loaded in page source and network call on Credit Gateway page for registered user
