...
#B-91344 QE only :: BCOM: Smart Prompt "Yes to Marketing" Pop Up and "No to Marketing" Pop Up
Feature: Epic Item E-10339 :: Smartprompt :: COM

#=============================================================================================
# Story Title: BCOM: Smart Prompt "Yes to Marketing" Pop Up and "No to Marketing" Pop Up
# Version One: BCOM Story B-91344
# VersionOne Link: https://www14.v1host.com/Macyscom/TeamRoom.mvc/Show/3670371
#=============================================================================================

  @desktop @marketing_domain @wip
  Scenario: Verify the functionality of Smart Prompt when the user having Yes to Marketing Emails submits his email
