...
###
###
Feature: Verify the guest eligible offers on desktop bag page as a guest user

  @Desktop_1
  Scenario: Verify the eligible offers section on bag page as guest user
  ...
  @Desktop_2
  Scenario: Verify no eligible offers section as a guest user
    Given I visit the web site as a guest user
    When I search for "4560460"
  ...
  @Desktop_3
  Scenario: Verify offer applied section as a guest user
    Given I visit the web site as a guest user
    When I search for "4560460"
    And I select "4" quantity
    And I add product to bag
