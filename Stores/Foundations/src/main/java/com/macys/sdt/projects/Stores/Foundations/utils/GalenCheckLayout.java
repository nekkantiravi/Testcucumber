package com.macys.sdt.projects.Stores.Foundations.utils;
...
public class GalenCheckLayout extends GalenTestNgTestBase {

    private static final Logger log = LoggerFactory.getLogger(GalenCheckLayout.class);
