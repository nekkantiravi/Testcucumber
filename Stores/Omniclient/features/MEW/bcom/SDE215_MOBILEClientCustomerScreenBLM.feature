...
Feature: As an associate using the mobile application, I want to view a customer's preferred information and have the
  ...
  @domain_stores @omniclient @Story_SDE-215 @bcom @MEW
  Scenario: Client Screen - View Preferred Info
    ...
    When I input the name "Krispen" on the By Name search page
    ...
    And I should see the preferred Customer Information
      | Name | Pref Name | Pref Address | Pref Phone | Pref Email |
    ...
    And I should see the Loyallist Level
...
#  TODO: Update the test to remove the client from book, once functionality will be in place
  @manual @domain_stores @omniclient @Story_SDE-215 @bcom @MEW
  Scenario: Add to Book - populate REQUIRED Information Fields
    Given I launch the bloomingdales's omniclient page on mobile
    When I sign into OmniClient BLM mobile application as Associate
    ...
    When I input first name "KERRY" on the FirstLastNameZip search page
    And I input last name "BLOW" on the FirstLastNameZip search page
    And I input the zip code "44053" on the FirstLastNameZip search page
    ...
    And I write the email in the Email field "email@blm.com"
    ...
    Then I should see the Client Profile page
#    TODO: enable commented asserts once SDE-262 is fixed
    ...
    And I should see the Preferred Contact method as "email"