...
Feature: As an associate, I want to see search results match the information I used to search so that I can avoid
  ...
  @domain_stores @omniclient @story_SDE-304 @website @mcom
  Scenario: Add Client for Test
    Given I launch the macy's omniclient page
    When I sign into Omniclient application as associate
    #parameters in this order: first name, last name, address, city , zip, hint
    And I add a new Macys Client: "FIRSTNM" "LASTNM" "PRIMADDR" "PRIMCITY" "12345" "TESTHINT" "4445556666" "AL"
    ...
    And we add additional address "SECADDR" "SECCITY" "54321" "WY" MACYS
