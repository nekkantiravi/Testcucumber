...
Feature: As an associate, I want the ability to add a customer's Credit card to their wallet so that I can
  ...
  @manual @domain_stores @omniclient @story_SDE-174 @website @mcom
  ...
  @manual @domain_stores @omniclient @story_SDE-174 @website @mcom
  Scenario: Add Individualized Card (same name) to a client (NO CC2ID) who is already in the OCL DB
    Given I launch the macy's omniclient page
    When I sign into Omniclient application as associate
    Then I should be logged in "associate" and see the omniclient landing page
    When I add a new Macys Client: "TEST1" "TEST ACCOUNT"
  ...
  @manual @domain_stores @omniclient @story_SDE-174 @website @mcom
  Scenario: Add Individualized Card (different name) to a client (NO CC2ID) who is already in the OCL DB - CANCEL & CONTINUE.
    Given I launch the macy's omniclient page
    When I sign into Omniclient application as associate
    Then I should be logged in "associate" and see the omniclient landing page
  ...
  @manual @domain_stores @omniclient @story_SDE-174 @website @mcom
  Scenario: Add Operational Card (same name) to a client (NO CC2ID) who is already in the OCL DB
    Given I launch the macy's omniclient page
    When I sign into Omniclient application as associate
    Then I should be logged in "associate" and see the omniclient landing page
    When I add a new Macys Client: "TEST2" "TEST ACCOUNT"
    And I navigate to Manage Client tab
    And I select the Wallet tab
    Then I should see the Wallet Screen
    When I select the Add Account button
  ...
  @manual @domain_stores @omniclient @story_SDE-174 @website @mcom
  Scenario: Add Operational Card (different name) to a client (NO CC2ID) who is already in the OCL DB - CANCEL & CONTINUE.
    GGiven I launch the macy's omniclient page
    When I sign into Omniclient application as associate
    Then I should be logged in "associate" and see the omniclient landing page
    When I add a new Macy's Client: "NewClientMacysTest" "UpdateData1Test"
    And I navigate to Manage Client tab
    And I select the Wallet tab
    Then I should see the Wallet Screen
    When I select the Add Account button
