...
Feature: As an associate, I want to search for customers using their phone number so that I can locate customer profiles and add customers to my book
  ...
  @domain_stores @omniclient @story_SDE-59 @website @bcom
  ...
  Scenario: Search results for a new added phone number is successfully done
    ...
    And we add additional third phone number "1122233341" BLM
    ...
    And the searched client is displayed in the search results page "KRAZY"
    When I click on the searched client "KRAZY BAKER"
    And I navigate to Manage Customer tab
    And I click on the Edit button from the CUSTOMER INFO section BLM
...
#  @manual @domain_stores @omniclient @story_SDE-59 @website @bcom
