...
Feature: As an associate, I want to filter customers by customer/loyalty/shopping attributes, in order
  ...
  @bcom @domain_stores @omniclient @website @story_SDE-521
  Scenario: Star Rewards / Loyallist Level Filter - View
    And I should see the "Loyallist Level" filter criteria Header Loyalty
