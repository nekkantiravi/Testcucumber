...
#    ONE Client added
    When I input client name "KRAZY" in the input filed from Create ToDo page
    And I select the full name "KRAZY BAKER" from client dropdown Create ToDo page
...
#    AN ADDITIONAL Client is added
    When I input client name "KONSTANCE" in the input filed from Create ToDo page
    And I select the full name "KONSTANCE BACKET" from client dropdown Create ToDo page
    And user clicks on the ADD button form Create TO Dos page
...
#    Input Credit Card Details
  ...
  Scenario: New Create To Do Screen - Single ToDos should be created instead of a List
    ...
    And I select the full name "KRAZY BAKER" from client dropdown Create ToDo page
    And user clicks on the ADD button form Create TO Dos page
    And I input client name "KONSTANCE" in the input filed from Create ToDo page
    And I select the full name "KONSTANCE BACKET" from client dropdown Create ToDo page
    And user clicks on the ADD button form Create TO Dos page
    ...
    And the To Do "TODONOTLIST" is saved on the Associates MY TO DOS tab for client "KRAZY BAKER"
    And the To Do "TODONOTLIST" is saved on the Associates MY TO DOS tab for client "KONSTANCE BACKET"
